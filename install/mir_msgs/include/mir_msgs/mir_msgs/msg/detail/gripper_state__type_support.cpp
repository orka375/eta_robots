...
{
  new (message_memory) mir_msgs::msg::GripperState(_init);
}

void GripperState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mir_msgs::msg::GripperState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperState_message_member_array[1] = {
  {
    ...
    offsetof(mir_msgs::msg::GripperState, state),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperState_message_members = {
  ...
  1,  // number of fields
  sizeof(mir_msgs::msg::GripperState),
...
{
  return &::mir_msgs::msg::rosidl_typesupport_introspection_cpp::GripperState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mir_msgs, msg, GripperState)() {
  return &::mir_msgs::msg::rosidl_typesupport_introspection_cpp::GripperState_message_type_support_handle;
}
