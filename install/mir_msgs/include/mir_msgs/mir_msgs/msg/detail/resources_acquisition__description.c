  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x17, 0x37, 0xf8, 0xaf, 0x5d, 0x0e, 0x6c, 0x5d,
      0x10, 0x89, 0x1b, 0x3f, 0x1d, 0x84, 0x57, 0x57,
      0xfc, 0xff, 0x35, 0x07, 0x20, 0xa5, 0xba, 0xb2,
      0x93, 0x24, 0xc0, 0xea, 0x27, 0xed, 0x8c, 0x22,
    }};
  return &hash;
}
...
static char mir_msgs__msg__ResourcesAcquisition__TYPE_NAME[] = "mir_msgs/msg/ResourcesAcquisition";
...
static char mir_msgs__msg__ResourcesAcquisition__FIELD_NAME__header[] = "header";
static char mir_msgs__msg__ResourcesAcquisition__FIELD_NAME__path[] = "path";
static char mir_msgs__msg__ResourcesAcquisition__FIELD_NAME__position_guid[] = "position_guid";
static char mir_msgs__msg__ResourcesAcquisition__FIELD_NAME__token[] = "token";

static rosidl_runtime_c__type_description__Field mir_msgs__msg__ResourcesAcquisition__FIELDS[] = {
  {
    {mir_msgs__msg__ResourcesAcquisition__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {mir_msgs__msg__ResourcesAcquisition__FIELD_NAME__path, 4, 4},
    {
  ...
  {
    {mir_msgs__msg__ResourcesAcquisition__FIELD_NAME__position_guid, 13, 13},
    {
  ...
  {
    {mir_msgs__msg__ResourcesAcquisition__FIELD_NAME__token, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mir_msgs__msg__ResourcesAcquisition__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {mir_msgs__msg__ResourcesAcquisition__TYPE_NAME, 33, 33},
      {mir_msgs__msg__ResourcesAcquisition__FIELDS, 4, 4},
    },
    {mir_msgs__msg__ResourcesAcquisition__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
mir_msgs__msg__ResourcesAcquisition__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mir_msgs__msg__ResourcesAcquisition__get_individual_type_description_source(NULL),
