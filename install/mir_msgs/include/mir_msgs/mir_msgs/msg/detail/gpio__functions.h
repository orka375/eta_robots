...
#ifndef MIR_MSGS__MSG__DETAIL__GPIO__FUNCTIONS_H_
#define MIR_MSGS__MSG__DETAIL__GPIO__FUNCTIONS_H_
 ...
 * calls
 * mir_msgs__msg__Gpio__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mir_msgs
mir_msgs__msg__Gpio *
mir_msgs__msg__Gpio__create(void);

/// Destroy msg/Gpio message.
/**
 * It calls
 * mir_msgs__msg__Gpio__fini()
...
/// Check for msg/Gpio message equality.
/**
 ...
 * mir_msgs__msg__Gpio__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mir_msgs__msg__Gpio__Sequence__fini()
 * on the array,
...
/// Check for msg/Gpio message array equality.
/**
...
/// Copy an array of msg/Gpio messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
...
#endif  // MIR_MSGS__MSG__DETAIL__GPIO__FUNCTIONS_H_
