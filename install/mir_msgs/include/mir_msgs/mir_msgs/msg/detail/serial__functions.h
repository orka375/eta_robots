...
#ifndef MIR_MSGS__MSG__DETAIL__SERIAL__FUNCTIONS_H_
#define MIR_MSGS__MSG__DETAIL__SERIAL__FUNCTIONS_H_
 ...
 * calls
 * mir_msgs__msg__Serial__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mir_msgs
mir_msgs__msg__Serial *
mir_msgs__msg__Serial__create(void);

/// Destroy msg/Serial message.
/**
 * It calls
 * mir_msgs__msg__Serial__fini()
 ...
 * mir_msgs__msg__Serial__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mir_msgs__msg__Serial__Sequence__fini()
 * on the array,
...
#endif  // MIR_MSGS__MSG__DETAIL__SERIAL__FUNCTIONS_H_
