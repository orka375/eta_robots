...
static char mir_msgs__msg__PlanSegment__FIELD_NAME__forward_motion[] = "forward_motion";
static char mir_msgs__msg__PlanSegment__FIELD_NAME__start_idx[] = "start_idx";
static char mir_msgs__msg__PlanSegment__FIELD_NAME__length[] = "length";
static char mir_msgs__msg__PlanSegment__FIELD_NAME__remaining_length[] = "remaining_length";
static char mir_msgs__msg__PlanSegment__FIELD_NAME__path[] = "path";

static rosidl_runtime_c__type_description__Field mir_msgs__msg__PlanSegment__FIELDS[] = {
  {
    {mir_msgs__msg__PlanSegment__FIELD_NAME__forward_motion, 14, 14},
    {
  ...
  {
    {mir_msgs__msg__PlanSegment__FIELD_NAME__start_idx, 9, 9},
    {
  ...
  {
    {mir_msgs__msg__PlanSegment__FIELD_NAME__length, 6, 6},
    {
  ...
  {
    {mir_msgs__msg__PlanSegment__FIELD_NAME__remaining_length, 16, 16},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {mir_msgs__msg__PlanSegment__FIELD_NAME__path, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription mir_msgs__msg__PlanSegment__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {mir_msgs__msg__PlanSegment__FIELDS, 5, 5},
    },
    {mir_msgs__msg__PlanSegment__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
mir_msgs__msg__PlanSegment__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *mir_msgs__msg__PlanSegment__get_individual_type_description_source(NULL),
