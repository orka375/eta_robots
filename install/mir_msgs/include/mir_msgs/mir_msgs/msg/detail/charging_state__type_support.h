...
#ifndef MIR_MSGS__MSG__DETAIL__CHARGING_STATE__TYPE_SUPPORT_H_
#define MIR_MSGS__MSG__DETAIL__CHARGING_STATE__TYPE_SUPPORT_H_
...
#endif  // MIR_MSGS__MSG__DETAIL__CHARGING_STATE__TYPE_SUPPORT_H_
