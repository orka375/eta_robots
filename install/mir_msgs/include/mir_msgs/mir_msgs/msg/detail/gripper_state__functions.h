...
#ifndef MIR_MSGS__MSG__DETAIL__GRIPPER_STATE__FUNCTIONS_H_
#define MIR_MSGS__MSG__DETAIL__GRIPPER_STATE__FUNCTIONS_H_
 ...
 * calls
 * mir_msgs__msg__GripperState__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mir_msgs
mir_msgs__msg__GripperState *
mir_msgs__msg__GripperState__create(void);

/// Destroy msg/GripperState message.
/**
 * It calls
 * mir_msgs__msg__GripperState__fini()
 ...
 * mir_msgs__msg__GripperState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mir_msgs__msg__GripperState__Sequence__fini()
 * on the array,
...
#endif  // MIR_MSGS__MSG__DETAIL__GRIPPER_STATE__FUNCTIONS_H_
