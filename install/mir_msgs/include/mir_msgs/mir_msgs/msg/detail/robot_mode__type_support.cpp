...
{
  new (message_memory) mir_msgs::msg::RobotMode(_init);
}

void RobotMode_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mir_msgs::msg::RobotMode *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotMode_message_member_array[2] = {
  {
    ...
    offsetof(mir_msgs::msg::RobotMode, robot_mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mir_msgs::msg::RobotMode, robot_mode_string),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::mir_msgs::msg::rosidl_typesupport_introspection_cpp::RobotMode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mir_msgs, msg, RobotMode)() {
  return &::mir_msgs::msg::rosidl_typesupport_introspection_cpp::RobotMode_message_type_support_handle;
}
