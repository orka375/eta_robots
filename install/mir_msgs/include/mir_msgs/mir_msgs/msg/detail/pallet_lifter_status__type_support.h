...
#ifndef MIR_MSGS__MSG__DETAIL__PALLET_LIFTER_STATUS__TYPE_SUPPORT_H_
#define MIR_MSGS__MSG__DETAIL__PALLET_LIFTER_STATUS__TYPE_SUPPORT_H_
...
#endif  // MIR_MSGS__MSG__DETAIL__PALLET_LIFTER_STATUS__TYPE_SUPPORT_H_
