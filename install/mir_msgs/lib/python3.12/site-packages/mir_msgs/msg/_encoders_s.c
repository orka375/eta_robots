...
bool mir_msgs__msg__encoders__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mir_msgs.msg._encoders", (char *)PyUnicode_1BYTE_DATA(module_attr), 22) == 0);
  ...
  mir_msgs__msg__Encoders * ros_message = _ros_message;
  {  // time_delta
...
PyObject * mir_msgs__msg__encoders__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mir_msgs.msg._encoders");
