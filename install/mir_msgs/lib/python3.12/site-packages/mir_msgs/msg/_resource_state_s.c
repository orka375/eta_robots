...
bool mir_msgs__msg__resource_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mir_msgs.msg._resource_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("ResourceState", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
  ...
  {  // resource_geometry
    PyObject * field = PyObject_GetAttrString(_pymsg, "resource_geometry");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'resource_geometry'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    geometry_msgs__msg__Point * dest = ros_message->resource_geometry.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * mir_msgs__msg__resource_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // resource_geometry
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->resource_geometry.data[i]);
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "resource_geometry", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
