...
bool mir_msgs__msg__pose2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mir_msgs.msg._pose2_d", (char *)PyUnicode_1BYTE_DATA(module_attr), 21) == 0);
  ...
  mir_msgs__msg__Pose2D * ros_message = _ros_message;
  {  // x
...
PyObject * mir_msgs__msg__pose2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mir_msgs.msg._pose2_d");
