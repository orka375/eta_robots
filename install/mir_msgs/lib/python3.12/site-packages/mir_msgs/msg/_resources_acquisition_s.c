...
bool mir_msgs__msg__resources_acquisition__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mir_msgs.msg._resources_acquisition", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("ResourcesAcquisition", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  mir_msgs__msg__ResourcesAcquisition * ros_message = _ros_message;
  {  // header
  ...
  {  // position_guid
    PyObject * field = PyObject_GetAttrString(_pymsg, "position_guid");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->position_guid, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of ResourcesAcquisition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mir_msgs.msg._resources_acquisition");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ResourcesAcquisition");
  ...
  {  // position_guid
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->position_guid.data,
      strlen(ros_message->position_guid.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "position_guid", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
