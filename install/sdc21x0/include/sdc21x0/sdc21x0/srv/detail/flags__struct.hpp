...
#ifndef _WIN32
# define DEPRECATED__sdc21x0__srv__Flags_Event __attribute__((deprecated))
#else
# define DEPRECATED__sdc21x0__srv__Flags_Event __declspec(deprecated)
#endif
...
struct Flags_Event_
{
  using Type = Flags_Event_<ContainerAllocator>;

  explicit Flags_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit Flags_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<sdc21x0::srv::Flags_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<sdc21x0::srv::Flags_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<sdc21x0::srv::Flags_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<sdc21x0::srv::Flags_Response_<ContainerAllocator>>>;
  _response_type response;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<sdc21x0::srv::Flags_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<sdc21x0::srv::Flags_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<sdc21x0::srv::Flags_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<sdc21x0::srv::Flags_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    sdc21x0::srv::Flags_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const sdc21x0::srv::Flags_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sdc21x0::srv::Flags_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sdc21x0::srv::Flags_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sdc21x0::srv::Flags_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sdc21x0::srv::Flags_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      sdc21x0::srv::Flags_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sdc21x0::srv::Flags_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sdc21x0::srv::Flags_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sdc21x0::srv::Flags_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sdc21x0__srv__Flags_Event
    std::shared_ptr<sdc21x0::srv::Flags_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sdc21x0__srv__Flags_Event
    std::shared_ptr<sdc21x0::srv::Flags_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const Flags_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using Flags_Event =
  sdc21x0::srv::Flags_Event_<std::allocator<void>>;
...
struct Flags
{
  ...
  using Event = sdc21x0::srv::Flags_Event;
};
