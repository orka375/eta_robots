...
class Metaclass_MotorCurrents(type):
    """Metaclass of message 'MotorCurrents'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'sdc21x0.msg.MotorCurrents')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__motor_currents
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__motor_currents
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__motor_currents
            cls._TYPE_SUPPORT = module.type_support_msg__msg__motor_currents
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__motor_currents
...
class MotorCurrents(metaclass=Metaclass_MotorCurrents):
    """Message class 'MotorCurrents'."""
