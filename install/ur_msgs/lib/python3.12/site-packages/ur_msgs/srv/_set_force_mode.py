...
class SetForceMode_Request(metaclass=Metaclass_SetForceMode_Request):
    ...
    def __eq__(self, other):
        ...
        if self.speed_limits != other.speed_limits:
            return False
        if any(self.deviation_limits != other.deviation_limits):
            return False
...
class Metaclass_SetForceMode_Event(type):
    """Metaclass of message 'SetForceMode_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_force_mode__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_force_mode__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_force_mode__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_force_mode__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_force_mode__event
...
class SetForceMode_Event(metaclass=Metaclass_SetForceMode_Event):
    """Message class 'SetForceMode_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ur_msgs/SetForceMode_Request, 1>',
        'response': 'sequence<ur_msgs/SetForceMode_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_msgs', 'srv'], 'SetForceMode_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_msgs', 'srv'], 'SetForceMode_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ur_msgs.srv import SetForceMode_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetForceMode_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetForceMode_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ur_msgs.srv import SetForceMode_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetForceMode_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetForceMode_Response'"
...
class Metaclass_SetForceMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_force_mode.Metaclass_SetForceMode_Event._TYPE_SUPPORT is None:
                _set_force_mode.Metaclass_SetForceMode_Event.__import_type_support__()
...
class SetForceMode(metaclass=Metaclass_SetForceMode):
    ...
    from ur_msgs.srv._set_force_mode import SetForceMode_Event as Event
