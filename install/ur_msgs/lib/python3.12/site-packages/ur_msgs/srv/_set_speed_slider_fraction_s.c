...
bool ur_msgs__srv__set_speed_slider_fraction__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_msgs.srv._set_speed_slider_fraction", (char *)PyUnicode_1BYTE_DATA(module_attr), 38) == 0);
    assert(strncmp("SetSpeedSliderFraction_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 30) == 0);
...
bool ur_msgs__srv__set_speed_slider_fraction__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("ur_msgs.srv._set_speed_slider_fraction", (char *)PyUnicode_1BYTE_DATA(module_attr), 38) == 0);
    assert(strncmp("SetSpeedSliderFraction_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 31) == 0);
...
bool ur_msgs__srv__set_speed_slider_fraction__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("ur_msgs.srv._set_speed_slider_fraction", (char *)PyUnicode_1BYTE_DATA(module_attr), 38) == 0);
    assert(strncmp("SetSpeedSliderFraction_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 28) == 0);
