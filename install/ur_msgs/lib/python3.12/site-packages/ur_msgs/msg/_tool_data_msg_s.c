...
bool ur_msgs__msg__tool_data_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_msgs.msg._tool_data_msg", (char *)PyUnicode_1BYTE_DATA(module_attr), 26) == 0);
    assert(strncmp("ToolDataMsg", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);
