...
#ifndef UR_MSGS__ACTION__DETAIL__FOLLOW_JOINT_TRAJECTORY_UNTIL__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
#define UR_MSGS__ACTION__DETAIL__FOLLOW_JOINT_TRAJECTORY_UNTIL__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ur_msgs, action, FollowJointTrajectoryUntil_SendGoal)();
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_PUBLIC_ur_msgs
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ur_msgs, action, FollowJointTrajectoryUntil_GetResult)();
...
#endif  // UR_MSGS__ACTION__DETAIL__FOLLOW_JOINT_TRAJECTORY_UNTIL__ROSIDL_TYPESUPPORT_INTROSPECTION_C_H_
