  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ur_dashboard_msgs__msg__UserRole * ros_message = static_cast<const ur_dashboard_msgs__msg__UserRole *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ur_dashboard_msgs__msg__UserRole(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ur_dashboard_msgs__msg__UserRole * ros_message = static_cast<ur_dashboard_msgs__msg__UserRole *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ur_dashboard_msgs__msg__UserRole(cdr, ros_message);
}
