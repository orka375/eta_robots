...
{
  new (message_memory) ur_dashboard_msgs::msg::SafetyStatus(_init);
}

void SafetyStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ur_dashboard_msgs::msg::SafetyStatus *>(message_memory);
  typed_message->~SafetyStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SafetyStatus_message_member_array[1] = {
  {
    "status",  // name
    ...
    offsetof(ur_dashboard_msgs::msg::SafetyStatus, status),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SafetyStatus_message_members = {
  ...
  1,  // number of fields
  sizeof(ur_dashboard_msgs::msg::SafetyStatus),
...
{
  return &::ur_dashboard_msgs::msg::rosidl_typesupport_introspection_cpp::SafetyStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_dashboard_msgs, msg, SafetyStatus)() {
  return &::ur_dashboard_msgs::msg::rosidl_typesupport_introspection_cpp::SafetyStatus_message_type_support_handle;
}
