...
ur_dashboard_msgs__msg__UserRole__init(ur_dashboard_msgs__msg__UserRole * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->role)) {
    ur_dashboard_msgs__msg__UserRole__fini(msg);
    return false;
  }
  return true;
}
...
ur_dashboard_msgs__msg__UserRole__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_dashboard_msgs__msg__UserRole * msg = (ur_dashboard_msgs__msg__UserRole *)allocator.allocate(sizeof(ur_dashboard_msgs__msg__UserRole), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ur_dashboard_msgs__msg__UserRole));
  bool success = ur_dashboard_msgs__msg__UserRole__init(msg);
  if (!success) {
...
ur_dashboard_msgs__msg__UserRole__Sequence__init(ur_dashboard_msgs__msg__UserRole__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_dashboard_msgs__msg__UserRole * data = NULL;

  if (size) {
    data = (ur_dashboard_msgs__msg__UserRole *)allocator.zero_allocate(size, sizeof(ur_dashboard_msgs__msg__UserRole), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ur_dashboard_msgs__msg__UserRole__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ur_dashboard_msgs__msg__UserRole__fini(&data[i - 1]);
      }
...
ur_dashboard_msgs__msg__UserRole__Sequence__fini(ur_dashboard_msgs__msg__UserRole__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ur_dashboard_msgs__msg__UserRole__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ur_dashboard_msgs__msg__UserRole__Sequence * array = (ur_dashboard_msgs__msg__UserRole__Sequence *)allocator.allocate(sizeof(ur_dashboard_msgs__msg__UserRole__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ur_dashboard_msgs__msg__UserRole__Sequence__init(array, size);
  if (!success) {
...
ur_dashboard_msgs__msg__UserRole__Sequence__destroy(ur_dashboard_msgs__msg__UserRole__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ur_dashboard_msgs__msg__UserRole__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ur_dashboard_msgs__msg__UserRole__Sequence__are_equal(const ur_dashboard_msgs__msg__UserRole__Sequence * lhs, const ur_dashboard_msgs__msg__UserRole__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ur_dashboard_msgs__msg__UserRole__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ur_dashboard_msgs__msg__UserRole__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ur_dashboard_msgs__msg__UserRole);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ur_dashboard_msgs__msg__UserRole * data =
      (ur_dashboard_msgs__msg__UserRole *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ur_dashboard_msgs__msg__UserRole__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ur_dashboard_msgs__msg__UserRole__fini(&output->data[i]);
        }
        return false;
      }
    }
