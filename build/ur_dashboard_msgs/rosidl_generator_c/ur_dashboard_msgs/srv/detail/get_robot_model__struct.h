...
enum
{
  ur_dashboard_msgs__srv__GetRobotModel_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ur_dashboard_msgs__srv__GetRobotModel_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetRobotModel in the package ur_dashboard_msgs.
typedef struct ur_dashboard_msgs__srv__GetRobotModel_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ur_dashboard_msgs__srv__GetRobotModel_Request__Sequence request;
  ur_dashboard_msgs__srv__GetRobotModel_Response__Sequence response;
} ur_dashboard_msgs__srv__GetRobotModel_Event;

// Struct for a sequence of ur_dashboard_msgs__srv__GetRobotModel_Event.
typedef struct ur_dashboard_msgs__srv__GetRobotModel_Event__Sequence
{
