...
enum
{
  ur_dashboard_msgs__srv__SetUserRole_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ur_dashboard_msgs__srv__SetUserRole_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/SetUserRole in the package ur_dashboard_msgs.
typedef struct ur_dashboard_msgs__srv__SetUserRole_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ur_dashboard_msgs__srv__SetUserRole_Request__Sequence request;
  ur_dashboard_msgs__srv__SetUserRole_Response__Sequence response;
} ur_dashboard_msgs__srv__SetUserRole_Event;

// Struct for a sequence of ur_dashboard_msgs__srv__SetUserRole_Event.
typedef struct ur_dashboard_msgs__srv__SetUserRole_Event__Sequence
{
