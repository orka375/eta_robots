...
enum
{
  ur_dashboard_msgs__srv__GenerateSupportFile_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ur_dashboard_msgs__srv__GenerateSupportFile_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GenerateSupportFile in the package ur_dashboard_msgs.
typedef struct ur_dashboard_msgs__srv__GenerateSupportFile_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ur_dashboard_msgs__srv__GenerateSupportFile_Request__Sequence request;
  ur_dashboard_msgs__srv__GenerateSupportFile_Response__Sequence response;
} ur_dashboard_msgs__srv__GenerateSupportFile_Event;

// Struct for a sequence of ur_dashboard_msgs__srv__GenerateSupportFile_Event.
typedef struct ur_dashboard_msgs__srv__GenerateSupportFile_Event__Sequence
{
