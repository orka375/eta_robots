...
enum
{
  ur_dashboard_msgs__srv__GetPrograms_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ur_dashboard_msgs__srv__GetPrograms_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/GetPrograms in the package ur_dashboard_msgs.
typedef struct ur_dashboard_msgs__srv__GetPrograms_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ur_dashboard_msgs__srv__GetPrograms_Request__Sequence request;
  ur_dashboard_msgs__srv__GetPrograms_Response__Sequence response;
} ur_dashboard_msgs__srv__GetPrograms_Event;

// Struct for a sequence of ur_dashboard_msgs__srv__GetPrograms_Event.
typedef struct ur_dashboard_msgs__srv__GetPrograms_Event__Sequence
{
