...
// IWYU pragma: private, include "ur_dashboard_msgs/action/set_mode.hpp"
...
template<>
inline const char * data_type<ur_dashboard_msgs::action::SetMode>()
{
  return "ur_dashboard_msgs::action::SetMode";
}

template<>
inline const char * name<ur_dashboard_msgs::action::SetMode>()
{
  return "ur_dashboard_msgs/action/SetMode";
}
