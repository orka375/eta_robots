...
static const _OperationalMode_type_support_symbol_names_t _OperationalMode_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_dashboard_msgs, msg, OperationalMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_dashboard_msgs, msg, OperationalMode)),
  }
};
...
{
  return &::ur_dashboard_msgs::msg::rosidl_typesupport_cpp::OperationalMode_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ur_dashboard_msgs, msg, OperationalMode)() {
  return get_message_type_support_handle<ur_dashboard_msgs::msg::OperationalMode>();
}
