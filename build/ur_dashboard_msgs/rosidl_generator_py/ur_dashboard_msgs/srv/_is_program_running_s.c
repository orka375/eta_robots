...
bool ur_dashboard_msgs__srv__is_program_running__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_dashboard_msgs.srv._is_program_running", (char *)PyUnicode_1BYTE_DATA(module_attr), 41) == 0);
    assert(strncmp("IsProgramRunning_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 24) == 0);
...
bool ur_dashboard_msgs__srv__is_program_running__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("ur_dashboard_msgs.srv._is_program_running", (char *)PyUnicode_1BYTE_DATA(module_attr), 41) == 0);
    assert(strncmp("IsProgramRunning_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 25) == 0);
...
bool ur_dashboard_msgs__srv__is_program_running__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("ur_dashboard_msgs.srv._is_program_running", (char *)PyUnicode_1BYTE_DATA(module_attr), 41) == 0);
    assert(strncmp("IsProgramRunning_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 22) == 0);
