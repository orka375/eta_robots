...
bool ur_dashboard_msgs__srv__get_program_state__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_dashboard_msgs.srv._get_program_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 40) == 0);
    assert(strncmp("GetProgramState_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 23) == 0);
...
bool ur_dashboard_msgs__srv__get_program_state__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("ur_dashboard_msgs.srv._get_program_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 40) == 0);
    assert(strncmp("GetProgramState_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 24) == 0);
...
ROSIDL_GENERATOR_C_EXPORT
bool ur_dashboard_msgs__srv__get_program_state__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    PyObject * class_attr = PyObject_GetAttrString(_pymsg, "__class__");
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("ur_dashboard_msgs.srv._get_program_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 40) == 0);
    assert(strncmp("GetProgramState_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 21) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  ur_dashboard_msgs__srv__GetProgramState_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!ur_dashboard_msgs__srv__GetProgramState_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ur_dashboard_msgs__srv__GetProgramState_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ur_dashboard_msgs__srv__GetProgramState_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ur_dashboard_msgs__srv__get_program_state__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!ur_dashboard_msgs__srv__GetProgramState_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ur_dashboard_msgs__srv__GetProgramState_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ur_dashboard_msgs__srv__GetProgramState_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ur_dashboard_msgs__srv__get_program_state__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of GetProgramState_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ur_dashboard_msgs.srv._get_program_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetProgramState_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    ur_dashboard_msgs__srv__GetProgramState_Request * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->request.data[i]);
      PyObject * pyitem = ur_dashboard_msgs__srv__get_program_state__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    ur_dashboard_msgs__srv__GetProgramState_Response * item;
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->response.data[i]);
      PyObject * pyitem = ur_dashboard_msgs__srv__get_program_state__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
