...
class Metaclass_GenerateFlightReport_Event(type):
    """Metaclass of message 'GenerateFlightReport_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__generate_flight_report__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__generate_flight_report__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__generate_flight_report__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__generate_flight_report__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__generate_flight_report__event
...
class GenerateFlightReport_Event(metaclass=Metaclass_GenerateFlightReport_Event):
    """Message class 'GenerateFlightReport_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ur_dashboard_msgs/GenerateFlightReport_Request, 1>',
        'response': 'sequence<ur_dashboard_msgs/GenerateFlightReport_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_dashboard_msgs', 'srv'], 'GenerateFlightReport_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_dashboard_msgs', 'srv'], 'GenerateFlightReport_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ur_dashboard_msgs.srv import GenerateFlightReport_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GenerateFlightReport_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GenerateFlightReport_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ur_dashboard_msgs.srv import GenerateFlightReport_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GenerateFlightReport_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GenerateFlightReport_Response'"
...
class Metaclass_GenerateFlightReport(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _generate_flight_report.Metaclass_GenerateFlightReport_Event._TYPE_SUPPORT is None:
                _generate_flight_report.Metaclass_GenerateFlightReport_Event.__import_type_support__()
...
class GenerateFlightReport(metaclass=Metaclass_GenerateFlightReport):
    ...
    from ur_dashboard_msgs.srv._generate_flight_report import GenerateFlightReport_Event as Event
