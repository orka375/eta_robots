...
class Metaclass_GetPolyScopeVersion_Event(type):
    """Metaclass of message 'GetPolyScopeVersion_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_poly_scope_version__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_poly_scope_version__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_poly_scope_version__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_poly_scope_version__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_poly_scope_version__event
...
class GetPolyScopeVersion_Event(metaclass=Metaclass_GetPolyScopeVersion_Event):
    """Message class 'GetPolyScopeVersion_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ur_dashboard_msgs/GetPolyScopeVersion_Request, 1>',
        'response': 'sequence<ur_dashboard_msgs/GetPolyScopeVersion_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_dashboard_msgs', 'srv'], 'GetPolyScopeVersion_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_dashboard_msgs', 'srv'], 'GetPolyScopeVersion_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ur_dashboard_msgs.srv import GetPolyScopeVersion_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetPolyScopeVersion_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetPolyScopeVersion_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ur_dashboard_msgs.srv import GetPolyScopeVersion_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetPolyScopeVersion_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetPolyScopeVersion_Response'"
...
class Metaclass_GetPolyScopeVersion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_poly_scope_version.Metaclass_GetPolyScopeVersion_Event._TYPE_SUPPORT is None:
                _get_poly_scope_version.Metaclass_GetPolyScopeVersion_Event.__import_type_support__()
...
class GetPolyScopeVersion(metaclass=Metaclass_GetPolyScopeVersion):
    ...
    from ur_dashboard_msgs.srv._get_poly_scope_version import GetPolyScopeVersion_Event as Event
