...
#include "ur_dashboard_msgs/msg/detail/user_role__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ur_dashboard_msgs::msg::UserRole & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ur_dashboard_msgs::msg::UserRole & ros_message)
{
  // Member: role
  cdr >> ros_message.role;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ur_dashboard_msgs::msg::UserRole;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ur_dashboard_msgs::msg::UserRole *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ur_dashboard_msgs::msg::UserRole *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UserRole__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ur_dashboard_msgs::msg::UserRole *>(
...
static size_t _UserRole__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UserRole(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UserRole__callbacks = {
...
static rosidl_message_type_support_t _UserRole__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UserRole__callbacks,
...
{
  return &ur_dashboard_msgs::msg::typesupport_fastrtps_cpp::_UserRole__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_dashboard_msgs, msg, UserRole)() {
  return &ur_dashboard_msgs::msg::typesupport_fastrtps_cpp::_UserRole__handle;
}
