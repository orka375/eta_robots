...
bool ur_msgs__msg__robot_mode_data_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_msgs.msg._robot_mode_data_msg", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("RobotModeDataMsg", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
