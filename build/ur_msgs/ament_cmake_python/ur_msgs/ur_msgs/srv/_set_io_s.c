...
bool ur_msgs__srv__set_io__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_msgs.srv._set_io", (char *)PyUnicode_1BYTE_DATA(module_attr), 19) == 0);
    assert(strncmp("SetIO_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
...
bool ur_msgs__srv__set_io__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("ur_msgs.srv._set_io", (char *)PyUnicode_1BYTE_DATA(module_attr), 19) == 0);
    assert(strncmp("SetIO_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 14) == 0);
...
bool ur_msgs__srv__set_io__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("ur_msgs.srv._set_io", (char *)PyUnicode_1BYTE_DATA(module_attr), 19) == 0);
    assert(strncmp("SetIO_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);
