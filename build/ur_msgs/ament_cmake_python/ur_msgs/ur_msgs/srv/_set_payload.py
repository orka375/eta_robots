...
class SetPayload_Request(metaclass=Metaclass_SetPayload_Request):
    ...
    _fields_and_field_types = {
        ...
        'ixz': 'double',
        'iyz': 'double',
        'transition_time': 'builtin_interfaces/Duration',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from builtin_interfaces.msg import Duration
        self.transition_time = kwargs.get('transition_time', Duration())
    ...
    def __eq__(self, other):
        ...
        if self.iyz != other.iyz:
            return False
        if self.transition_time != other.transition_time:
            return False
        return True
    ...
    def transition_time(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'transition_time' field must be a sub message of type 'Duration'"
...
class SetPayload_Event(metaclass=Metaclass_SetPayload_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ur_msgs/SetPayload_Request, 1>',
        'response': 'sequence<ur_msgs/SetPayload_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_msgs', 'srv'], 'SetPayload_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ur_msgs', 'srv'], 'SetPayload_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ur_msgs.srv import SetPayload_Request
    ...
    def response(self, value):
        if self._check_fields:
            from ur_msgs.srv import SetPayload_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class SetPayload(metaclass=Metaclass_SetPayload):
    ...
    from ur_msgs.srv._set_payload import SetPayload_Event as Event
