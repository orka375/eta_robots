...
bool ur_msgs__srv__set_payload__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ur_msgs.srv._set_payload", (char *)PyUnicode_1BYTE_DATA(module_attr), 24) == 0);
    assert(strncmp("SetPayload_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
  ...
  {  // transition_time
    PyObject * field = PyObject_GetAttrString(_pymsg, "transition_time");
    if (!field) {
      return false;
    }
    if (!builtin_interfaces__msg__duration__convert_from_py(field, &ros_message->transition_time)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * ur_msgs__srv__set_payload__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // transition_time
    PyObject * field = NULL;
    field = builtin_interfaces__msg__duration__convert_to_py(&ros_message->transition_time);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "transition_time", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
bool ur_msgs__srv__set_payload__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("ur_msgs.srv._set_payload", (char *)PyUnicode_1BYTE_DATA(module_attr), 24) == 0);
    assert(strncmp("SetPayload_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 19) == 0);
...
ROSIDL_GENERATOR_C_EXPORT
bool ur_msgs__srv__set_payload__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    PyObject * class_attr = PyObject_GetAttrString(_pymsg, "__class__");
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("ur_msgs.srv._set_payload", (char *)PyUnicode_1BYTE_DATA(module_attr), 24) == 0);
    assert(strncmp("SetPayload_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  ur_msgs__srv__SetPayload_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!ur_msgs__srv__SetPayload_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ur_msgs__srv__SetPayload_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ur_msgs__srv__SetPayload_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ur_msgs__srv__set_payload__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!ur_msgs__srv__SetPayload_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ur_msgs__srv__SetPayload_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ur_msgs__srv__SetPayload_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ur_msgs__srv__set_payload__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
PyObject * ur_msgs__srv__set_payload__event__convert_to_py(void * raw_ros_message)
{
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ur_msgs__srv__set_payload__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ur_msgs__srv__set_payload__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
