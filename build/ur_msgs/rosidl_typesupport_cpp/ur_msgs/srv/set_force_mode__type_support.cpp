...
typedef struct _SetForceMode_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _SetForceMode_Event_type_support_ids_t;

static const _SetForceMode_Event_type_support_ids_t _SetForceMode_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _SetForceMode_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _SetForceMode_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _SetForceMode_Event_type_support_symbol_names_t _SetForceMode_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ur_msgs, srv, SetForceMode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ur_msgs, srv, SetForceMode_Event)),
  }
};

typedef struct _SetForceMode_Event_type_support_data_t
{
  void * data[2];
} _SetForceMode_Event_type_support_data_t;

static _SetForceMode_Event_type_support_data_t _SetForceMode_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _SetForceMode_Event_message_typesupport_map = {
  2,
  "ur_msgs",
  &_SetForceMode_Event_message_typesupport_ids.typesupport_identifier[0],
  &_SetForceMode_Event_message_typesupport_symbol_names.symbol_name[0],
  &_SetForceMode_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t SetForceMode_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_SetForceMode_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::ur_msgs::srv::rosidl_typesupport_cpp::SetForceMode_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ur_msgs, srv, SetForceMode_Event)() {
  return get_message_type_support_handle<ur_msgs::srv::SetForceMode_Event>();
}
...
static const rosidl_service_type_support_t SetForceMode_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ur_msgs::srv::SetForceMode_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ur_msgs::srv::SetForceMode_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<ur_msgs::srv::SetForceMode_Event>(),
