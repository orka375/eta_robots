  ...
  const rosidl_service_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x75, 0xb0, 0x21, 0xdb, 0xf7, 0x65, 0xd4, 0x9d,
      0x4c, 0x23, 0x8d, 0x6f, 0x00, 0xa2, 0x10, 0xc6,
      0xb8, 0x98, 0x57, 0xe1, 0x6e, 0x9a, 0x4b, 0x7e,
      0xdd, 0xd7, 0xd3, 0xb5, 0x46, 0xc1, 0xf9, 0x2b,
    }};
  return &hash;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0xaf, 0x57, 0x40, 0x34, 0xf2, 0xb1, 0x4a, 0xa1,
      0x08, 0x1a, 0x65, 0x6b, 0xb9, 0xf0, 0x36, 0x56,
      0xf9, 0xe4, 0x03, 0xaf, 0xf2, 0xe9, 0x44, 0x41,
      0xcb, 0xdc, 0xd3, 0x4f, 0xc0, 0xb0, 0xdf, 0x2a,
    }};
  return &hash;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0xc9, 0x38, 0x8f, 0x0e, 0x58, 0x6b, 0x55, 0xb7,
      0x81, 0x32, 0xb8, 0x52, 0x29, 0x84, 0xee, 0x3a,
      0x6d, 0x20, 0x61, 0xd6, 0x11, 0x81, 0x7c, 0x99,
      0x45, 0x93, 0x95, 0xd1, 0xb5, 0x9a, 0xa3, 0xf7,
    }};
  return &hash;
}
  ...
  const rosidl_service_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    ...
    {ur_msgs__srv__SetPayload__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[4].fields = ur_msgs__srv__SetPayload_Event__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[5].fields = ur_msgs__srv__SetPayload_Request__get_type_description(NULL)->type_description.fields;
    description.referenced_type_descriptions.data[6].fields = ur_msgs__srv__SetPayload_Response__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char ur_msgs__srv__SetPayload_Request__FIELD_NAME__ixx[] = "ixx";
static char ur_msgs__srv__SetPayload_Request__FIELD_NAME__iyy[] = "iyy";
static char ur_msgs__srv__SetPayload_Request__FIELD_NAME__izz[] = "izz";
static char ur_msgs__srv__SetPayload_Request__FIELD_NAME__ixy[] = "ixy";
static char ur_msgs__srv__SetPayload_Request__FIELD_NAME__ixz[] = "ixz";
static char ur_msgs__srv__SetPayload_Request__FIELD_NAME__iyz[] = "iyz";
static char ur_msgs__srv__SetPayload_Request__FIELD_NAME__transition_time[] = "transition_time";
...
static rosidl_runtime_c__type_description__Field ur_msgs__srv__SetPayload_Request__FIELDS[] = {
  ...
  {
    {ur_msgs__srv__SetPayload_Request__FIELD_NAME__ixx, 3, 3},
    {
  ...
  {
    {ur_msgs__srv__SetPayload_Request__FIELD_NAME__iyy, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {ur_msgs__srv__SetPayload_Request__FIELD_NAME__izz, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {ur_msgs__srv__SetPayload_Request__FIELD_NAME__ixy, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {ur_msgs__srv__SetPayload_Request__FIELD_NAME__ixz, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {ur_msgs__srv__SetPayload_Request__FIELD_NAME__iyz, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_DOUBLE,
      0,
      0,
  ...
  {
    {ur_msgs__srv__SetPayload_Request__FIELD_NAME__transition_time, 15, 15},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {ur_msgs__srv__SetPayload_Request__TYPE_NAME, 30, 30},
      {ur_msgs__srv__SetPayload_Request__FIELDS, 9, 9},
    },
    {ur_msgs__srv__SetPayload_Request__REFERENCED_TYPE_DESCRIPTIONS, 2, 2},
  };
  if (!constructed) {
    assert(0 == memcmp(&builtin_interfaces__msg__Duration__EXPECTED_HASH, builtin_interfaces__msg__Duration__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = builtin_interfaces__msg__Duration__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    ...
    {ur_msgs__srv__SetPayload_Event__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
    assert(0 == memcmp(&builtin_interfaces__msg__Duration__EXPECTED_HASH, builtin_interfaces__msg__Duration__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = builtin_interfaces__msg__Duration__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_service_type_support_t * type_support)
{
  ...
  if (!constructed) {
    ...
    sources[5] = *ur_msgs__srv__SetPayload_Event__get_individual_type_description_source(NULL);
    sources[6] = *ur_msgs__srv__SetPayload_Request__get_individual_type_description_source(NULL);
    sources[7] = *ur_msgs__srv__SetPayload_Response__get_individual_type_description_source(NULL);
    constructed = true;
  }
