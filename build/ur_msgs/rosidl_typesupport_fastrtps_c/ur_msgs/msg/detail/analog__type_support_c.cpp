  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ur_msgs__msg__Analog * ros_message = static_cast<const ur_msgs__msg__Analog *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ur_msgs__msg__Analog(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ur_msgs__msg__Analog * ros_message = static_cast<ur_msgs__msg__Analog *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ur_msgs__msg__Analog(cdr, ros_message);
}
