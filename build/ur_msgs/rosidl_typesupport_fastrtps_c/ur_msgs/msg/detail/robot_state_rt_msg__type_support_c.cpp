...
bool cdr_serialize_ur_msgs__msg__RobotStateRTMsg(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
bool cdr_deserialize_ur_msgs__msg__RobotStateRTMsg(
  eprosima::fastcdr::Cdr & cdr,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
bool cdr_serialize_key_ur_msgs__msg__RobotStateRTMsg(
  const ur_msgs__msg__RobotStateRTMsg * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: time
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t get_serialized_size_key_ur_msgs__msg__RobotStateRTMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RobotStateRTMsg__ros_msg_type * ros_message = static_cast<const _RobotStateRTMsg__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t max_serialized_size_key_ur_msgs__msg__RobotStateRTMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ur_msgs__msg__RobotStateRTMsg * ros_message = static_cast<const ur_msgs__msg__RobotStateRTMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ur_msgs__msg__RobotStateRTMsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ur_msgs__msg__RobotStateRTMsg * ros_message = static_cast<ur_msgs__msg__RobotStateRTMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ur_msgs__msg__RobotStateRTMsg(cdr, ros_message);
}
