...
#include "builtin_interfaces/msg/detail/duration__functions.h"  // transition_time
...
bool cdr_serialize_ur_msgs__srv__SetPayload_Request(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: transition_time
  {
    cdr_serialize_builtin_interfaces__msg__Duration(
      &ros_message->transition_time, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
bool cdr_deserialize_ur_msgs__srv__SetPayload_Request(
  eprosima::fastcdr::Cdr & cdr,
  ur_msgs__srv__SetPayload_Request * ros_message)
{
  ...
  // Field name: center_of_gravity
  {
    cdr_deserialize_geometry_msgs__msg__Vector3(cdr, &ros_message->center_of_gravity);
  }
  ...
  // Field name: transition_time
  {
    cdr_deserialize_builtin_interfaces__msg__Duration(cdr, &ros_message->transition_time);
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_builtin_interfaces__msg__Duration(
    &(ros_message->transition_time), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, transition_time) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
bool cdr_serialize_key_ur_msgs__srv__SetPayload_Request(
  const ur_msgs__srv__SetPayload_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: mass
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t get_serialized_size_key_ur_msgs__srv__SetPayload_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPayload_Request__ros_msg_type * ros_message = static_cast<const _SetPayload_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t max_serialized_size_key_ur_msgs__srv__SetPayload_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ur_msgs__srv__SetPayload_Request * ros_message = static_cast<const ur_msgs__srv__SetPayload_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ur_msgs__srv__SetPayload_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ur_msgs__srv__SetPayload_Request * ros_message = static_cast<ur_msgs__srv__SetPayload_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ur_msgs__srv__SetPayload_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
bool cdr_serialize_ur_msgs__srv__SetPayload_Response(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
bool cdr_deserialize_ur_msgs__srv__SetPayload_Response(
  eprosima::fastcdr::Cdr & cdr,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
bool cdr_serialize_key_ur_msgs__srv__SetPayload_Response(
  const ur_msgs__srv__SetPayload_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: success
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t get_serialized_size_key_ur_msgs__srv__SetPayload_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPayload_Response__ros_msg_type * ros_message = static_cast<const _SetPayload_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t max_serialized_size_key_ur_msgs__srv__SetPayload_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ur_msgs__srv__SetPayload_Response * ros_message = static_cast<const ur_msgs__srv__SetPayload_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ur_msgs__srv__SetPayload_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ur_msgs__srv__SetPayload_Response * ros_message = static_cast<ur_msgs__srv__SetPayload_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ur_msgs__srv__SetPayload_Response(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
bool cdr_serialize_ur_msgs__srv__SetPayload_Event(
  const ur_msgs__srv__SetPayload_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ur_msgs__srv__SetPayload_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_ur_msgs__srv__SetPayload_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
bool cdr_deserialize_ur_msgs__srv__SetPayload_Event(
  eprosima::fastcdr::Cdr & cdr,
  ur_msgs__srv__SetPayload_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ur_msgs__srv__SetPayload_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_ur_msgs__srv__SetPayload_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
bool cdr_serialize_key_ur_msgs__srv__SetPayload_Event(
  const ur_msgs__srv__SetPayload_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ur_msgs__srv__SetPayload_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_ur_msgs__srv__SetPayload_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t get_serialized_size_key_ur_msgs__srv__SetPayload_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPayload_Event__ros_msg_type * ros_message = static_cast<const _SetPayload_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ur_msgs__srv__SetPayload_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_ur_msgs__srv__SetPayload_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ur_msgs
size_t max_serialized_size_key_ur_msgs__srv__SetPayload_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ur_msgs__srv__SetPayload_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_ur_msgs__srv__SetPayload_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const ur_msgs__srv__SetPayload_Event * ros_message = static_cast<const ur_msgs__srv__SetPayload_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_ur_msgs__srv__SetPayload_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  ur_msgs__srv__SetPayload_Event * ros_message = static_cast<ur_msgs__srv__SetPayload_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_ur_msgs__srv__SetPayload_Event(cdr, ros_message);
}
