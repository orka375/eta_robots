...
class Init_SetForceMode_Event_response
{
public:
  explicit Init_SetForceMode_Event_response(::ur_msgs::srv::SetForceMode_Event & msg)
  : msg_(msg)
  {}
  ::ur_msgs::srv::SetForceMode_Event response(::ur_msgs::srv::SetForceMode_Event::_response_type arg)
  {
...
private:
  ::ur_msgs::srv::SetForceMode_Event msg_;
};

class Init_SetForceMode_Event_request
{
public:
  explicit Init_SetForceMode_Event_request(::ur_msgs::srv::SetForceMode_Event & msg)
  : msg_(msg)
  {}
  Init_SetForceMode_Event_response request(::ur_msgs::srv::SetForceMode_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_SetForceMode_Event_response(msg_);
  }
...
class Init_SetForceMode_Event_info
{
public:
  Init_SetForceMode_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SetForceMode_Event_request info(::ur_msgs::srv::SetForceMode_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_SetForceMode_Event_request(msg_);
  }
...
template<>
inline
auto build<::ur_msgs::srv::SetForceMode_Event>()
{
  return ur_msgs::srv::builder::Init_SetForceMode_Event_info();
}
