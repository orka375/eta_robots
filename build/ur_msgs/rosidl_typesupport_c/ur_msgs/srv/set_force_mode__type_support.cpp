...
static const _SetForceMode_Event_type_support_symbol_names_t _SetForceMode_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ur_msgs, srv, SetForceMode_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ur_msgs, srv, SetForceMode_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ur_msgs, srv, SetForceMode_Event)() {
  return &::ur_msgs::srv::rosidl_typesupport_c::SetForceMode_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetForceMode_service_type_support_handle = {
  ...
  &SetForceMode_Request_message_type_support_handle,
  &SetForceMode_Response_message_type_support_handle,
  &SetForceMode_Event_message_type_support_handle,
