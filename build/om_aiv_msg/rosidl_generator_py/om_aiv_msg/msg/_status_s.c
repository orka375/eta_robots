...
bool om_aiv_msg__msg__location__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * om_aiv_msg__msg__location__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool om_aiv_msg__msg__status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("om_aiv_msg.msg._status", (char *)PyUnicode_1BYTE_DATA(module_attr), 22) == 0);
    assert(strncmp("Status", (char *)PyUnicode_1BYTE_DATA(name_attr), 6) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  om_aiv_msg__msg__Status * ros_message = _ros_message;
  {  // extended_status
  ...
  {  // location
    ...
    if (!om_aiv_msg__msg__location__convert_from_py(field, &ros_message->location)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * om_aiv_msg__msg__status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("om_aiv_msg.msg._status");
  ...
  {  // location
    PyObject * field = NULL;
    field = om_aiv_msg__msg__location__convert_to_py(&ros_message->location);
    if (!field) {
      return NULL;
    }
    {
