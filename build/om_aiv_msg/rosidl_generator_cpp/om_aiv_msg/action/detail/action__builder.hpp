...
class Init_Action_SendGoal_Event_response
{
public:
  explicit Init_Action_SendGoal_Event_response(::om_aiv_msg::action::Action_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::om_aiv_msg::action::Action_SendGoal_Event response(::om_aiv_msg::action::Action_SendGoal_Event::_response_type arg)
  {
...
private:
  ::om_aiv_msg::action::Action_SendGoal_Event msg_;
};

class Init_Action_SendGoal_Event_request
{
public:
  explicit Init_Action_SendGoal_Event_request(::om_aiv_msg::action::Action_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_Action_SendGoal_Event_response request(::om_aiv_msg::action::Action_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Action_SendGoal_Event_response(msg_);
  }
...
class Init_Action_SendGoal_Event_info
{
public:
  Init_Action_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Action_SendGoal_Event_request info(::om_aiv_msg::action::Action_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Action_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::om_aiv_msg::action::Action_SendGoal_Event>()
{
  return om_aiv_msg::action::builder::Init_Action_SendGoal_Event_info();
}
...
class Init_Action_GetResult_Event_response
{
public:
  explicit Init_Action_GetResult_Event_response(::om_aiv_msg::action::Action_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::om_aiv_msg::action::Action_GetResult_Event response(::om_aiv_msg::action::Action_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::om_aiv_msg::action::Action_GetResult_Event msg_;
};

class Init_Action_GetResult_Event_request
{
public:
  explicit Init_Action_GetResult_Event_request(::om_aiv_msg::action::Action_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_Action_GetResult_Event_response request(::om_aiv_msg::action::Action_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_Action_GetResult_Event_response(msg_);
  }
...
class Init_Action_GetResult_Event_info
{
public:
  Init_Action_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_Action_GetResult_Event_request info(::om_aiv_msg::action::Action_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_Action_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::om_aiv_msg::action::Action_GetResult_Event>()
{
  return om_aiv_msg::action::builder::Init_Action_GetResult_Event_info();
}
