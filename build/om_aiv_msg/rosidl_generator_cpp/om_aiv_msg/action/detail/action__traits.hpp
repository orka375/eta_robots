  ...
  std::ostream & out)
{
  ...
  // member: identifier
  {
    if (msg.identifier.size() == 0) {
      ...
      out << "identifier: [";
      size_t pending_items = msg.identifier.size();
      for (auto item : msg.identifier) {
...
[[deprecated("use om_aiv_msg::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const om_aiv_msg::action::Action_Goal & msg,
  std::ostream & out, size_t indentation = 0)
{
  om_aiv_msg::action::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use om_aiv_msg::action::to_yaml() instead")]]
inline std::string to_yaml(const om_aiv_msg::action::Action_Goal & msg)
{
  return om_aiv_msg::action::to_yaml(msg);
}
  ...
  std::ostream & out)
{
  ...
  {
    out << "res_msg: ";
    rosidl_generator_traits::value_to_yaml(msg.res_msg, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)
...
[[deprecated("use om_aiv_msg::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const om_aiv_msg::action::Action_Result & msg,
  std::ostream & out, size_t indentation = 0)
{
  om_aiv_msg::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use om_aiv_msg::action::to_yaml() instead")]]
inline std::string to_yaml(const om_aiv_msg::action::Action_Result & msg)
{
  return om_aiv_msg::action::to_yaml(msg);
}
  ...
  std::ostream & out)
{
  ...
  {
    out << "feed_msg: ";
    rosidl_generator_traits::value_to_yaml(msg.feed_msg, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)
...
[[deprecated("use om_aiv_msg::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const om_aiv_msg::action::Action_Feedback & msg,
  std::ostream & out, size_t indentation = 0)
{
  om_aiv_msg::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use om_aiv_msg::action::to_yaml() instead")]]
inline std::string to_yaml(const om_aiv_msg::action::Action_Feedback & msg)
{
  return om_aiv_msg::action::to_yaml(msg);
}
...
[[deprecated("use om_aiv_msg::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const om_aiv_msg::action::Action_SendGoal_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  om_aiv_msg::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use om_aiv_msg::action::to_yaml() instead")]]
inline std::string to_yaml(const om_aiv_msg::action::Action_SendGoal_Request & msg)
{
  return om_aiv_msg::action::to_yaml(msg);
}
...
[[deprecated("use om_aiv_msg::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const om_aiv_msg::action::Action_SendGoal_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  om_aiv_msg::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use om_aiv_msg::action::to_yaml() instead")]]
inline std::string to_yaml(const om_aiv_msg::action::Action_SendGoal_Response & msg)
{
  return om_aiv_msg::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const Action_SendGoal_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const Action_SendGoal_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use om_aiv_msg::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const om_aiv_msg::action::Action_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  om_aiv_msg::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use om_aiv_msg::action::to_yaml() instead")]]
inline std::string to_yaml(const om_aiv_msg::action::Action_SendGoal_Event & msg)
{
  return om_aiv_msg::action::to_yaml(msg);
}

template<>
inline const char * data_type<om_aiv_msg::action::Action_SendGoal_Event>()
{
  return "om_aiv_msg::action::Action_SendGoal_Event";
}

template<>
inline const char * name<om_aiv_msg::action::Action_SendGoal_Event>()
{
  return "om_aiv_msg/action/Action_SendGoal_Event";
}

template<>
struct has_fixed_size<om_aiv_msg::action::Action_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<om_aiv_msg::action::Action_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<om_aiv_msg::action::Action_SendGoal_Request>::value && has_bounded_size<om_aiv_msg::action::Action_SendGoal_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<om_aiv_msg::action::Action_SendGoal_Event>
  : std::true_type {};
...
[[deprecated("use om_aiv_msg::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const om_aiv_msg::action::Action_GetResult_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  om_aiv_msg::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use om_aiv_msg::action::to_yaml() instead")]]
inline std::string to_yaml(const om_aiv_msg::action::Action_GetResult_Request & msg)
{
  return om_aiv_msg::action::to_yaml(msg);
}
...
[[deprecated("use om_aiv_msg::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const om_aiv_msg::action::Action_GetResult_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  om_aiv_msg::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use om_aiv_msg::action::to_yaml() instead")]]
inline std::string to_yaml(const om_aiv_msg::action::Action_GetResult_Response & msg)
{
  return om_aiv_msg::action::to_yaml(msg);
}
...
inline void to_flow_style_yaml(
  const Action_GetResult_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const Action_GetResult_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use om_aiv_msg::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const om_aiv_msg::action::Action_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  om_aiv_msg::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use om_aiv_msg::action::to_yaml() instead")]]
inline std::string to_yaml(const om_aiv_msg::action::Action_GetResult_Event & msg)
{
  return om_aiv_msg::action::to_yaml(msg);
}

template<>
inline const char * data_type<om_aiv_msg::action::Action_GetResult_Event>()
{
  return "om_aiv_msg::action::Action_GetResult_Event";
}

template<>
inline const char * name<om_aiv_msg::action::Action_GetResult_Event>()
{
  return "om_aiv_msg/action/Action_GetResult_Event";
}

template<>
struct has_fixed_size<om_aiv_msg::action::Action_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<om_aiv_msg::action::Action_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<om_aiv_msg::action::Action_GetResult_Request>::value && has_bounded_size<om_aiv_msg::action::Action_GetResult_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<om_aiv_msg::action::Action_GetResult_Event>
  : std::true_type {};
...
[[deprecated("use om_aiv_msg::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const om_aiv_msg::action::Action_FeedbackMessage & msg,
  std::ostream & out, size_t indentation = 0)
{
  om_aiv_msg::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use om_aiv_msg::action::to_yaml() instead")]]
inline std::string to_yaml(const om_aiv_msg::action::Action_FeedbackMessage & msg)
{
  return om_aiv_msg::action::to_yaml(msg);
}
...
template<>
inline const char * data_type<om_aiv_msg::action::Action>()
{
  return "om_aiv_msg::action::Action";
}

template<>
inline const char * name<om_aiv_msg::action::Action>()
{
  return "om_aiv_msg/action/Action";
}
