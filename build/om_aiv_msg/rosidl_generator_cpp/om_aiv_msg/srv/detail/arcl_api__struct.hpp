...
#ifndef _WIN32
# define DEPRECATED__om_aiv_msg__srv__ArclApi_Event __attribute__((deprecated))
#else
# define DEPRECATED__om_aiv_msg__srv__ArclApi_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct ArclApi_Event_
{
  using Type = ArclApi_Event_<ContainerAllocator>;

  explicit ArclApi_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit ArclApi_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<om_aiv_msg::srv::ArclApi_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<om_aiv_msg::srv::ArclApi_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<om_aiv_msg::srv::ArclApi_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<om_aiv_msg::srv::ArclApi_Response_<ContainerAllocator>>>;
  _response_type response;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<om_aiv_msg::srv::ArclApi_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<om_aiv_msg::srv::ArclApi_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<om_aiv_msg::srv::ArclApi_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<om_aiv_msg::srv::ArclApi_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__om_aiv_msg__srv__ArclApi_Event
    std::shared_ptr<om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__om_aiv_msg__srv__ArclApi_Event
    std::shared_ptr<om_aiv_msg::srv::ArclApi_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const ArclApi_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using ArclApi_Event =
  om_aiv_msg::srv::ArclApi_Event_<std::allocator<void>>;
...
struct ArclApi
{
  ...
  using Event = om_aiv_msg::srv::ArclApi_Event;
};
