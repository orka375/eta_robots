...
#include "om_aiv_msg/msg/detail/location__rosidl_typesupport_fastrtps_c.h"
...
using _Location__ros_msg_type = om_aiv_msg__msg__Location;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = om_aiv_msg__msg__Location;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const om_aiv_msg__msg__Location * ros_message = static_cast<const om_aiv_msg__msg__Location *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_om_aiv_msg__msg__Location(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  om_aiv_msg__msg__Location * ros_message = static_cast<om_aiv_msg__msg__Location *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_om_aiv_msg__msg__Location(cdr, ros_message);
}

static uint32_t _Location__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_om_aiv_msg__msg__Location(
...
static size_t _Location__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_om_aiv_msg__msg__Location(
