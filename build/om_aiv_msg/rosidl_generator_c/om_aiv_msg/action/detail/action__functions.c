...
om_aiv_msg__action__Action_Goal__create(void)
{
  ...
  om_aiv_msg__action__Action_Goal * msg = (om_aiv_msg__action__Action_Goal *)allocator.allocate(sizeof(om_aiv_msg__action__Action_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
...
om_aiv_msg__action__Action_Goal__Sequence__init(om_aiv_msg__action__Action_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (om_aiv_msg__action__Action_Goal *)allocator.zero_allocate(size, sizeof(om_aiv_msg__action__Action_Goal), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_Goal__Sequence * array = (om_aiv_msg__action__Action_Goal__Sequence *)allocator.allocate(sizeof(om_aiv_msg__action__Action_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
om_aiv_msg__action__Action_Goal__Sequence__are_equal(const om_aiv_msg__action__Action_Goal__Sequence * lhs, const om_aiv_msg__action__Action_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!om_aiv_msg__action__Action_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  om_aiv_msg__action__Action_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(om_aiv_msg__action__Action_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    om_aiv_msg__action__Action_Goal * data =
      (om_aiv_msg__action__Action_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!om_aiv_msg__action__Action_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          om_aiv_msg__action__Action_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!om_aiv_msg__action__Action_Goal__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_Result * msg = (om_aiv_msg__action__Action_Result *)allocator.allocate(sizeof(om_aiv_msg__action__Action_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
...
om_aiv_msg__action__Action_Result__Sequence__init(om_aiv_msg__action__Action_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (om_aiv_msg__action__Action_Result *)allocator.zero_allocate(size, sizeof(om_aiv_msg__action__Action_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_Result__Sequence * array = (om_aiv_msg__action__Action_Result__Sequence *)allocator.allocate(sizeof(om_aiv_msg__action__Action_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
om_aiv_msg__action__Action_Result__Sequence__are_equal(const om_aiv_msg__action__Action_Result__Sequence * lhs, const om_aiv_msg__action__Action_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!om_aiv_msg__action__Action_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  om_aiv_msg__action__Action_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(om_aiv_msg__action__Action_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    om_aiv_msg__action__Action_Result * data =
      (om_aiv_msg__action__Action_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!om_aiv_msg__action__Action_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          om_aiv_msg__action__Action_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!om_aiv_msg__action__Action_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
  ...
  om_aiv_msg__action__Action_Feedback * output)
{
  ...
  // feed_msg
  if (!rosidl_runtime_c__String__copy(
      &(input->feed_msg), &(output->feed_msg)))
  {
    return false;
  }
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_Feedback * msg = (om_aiv_msg__action__Action_Feedback *)allocator.allocate(sizeof(om_aiv_msg__action__Action_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
...
om_aiv_msg__action__Action_Feedback__Sequence__init(om_aiv_msg__action__Action_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (om_aiv_msg__action__Action_Feedback *)allocator.zero_allocate(size, sizeof(om_aiv_msg__action__Action_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_Feedback__Sequence * array = (om_aiv_msg__action__Action_Feedback__Sequence *)allocator.allocate(sizeof(om_aiv_msg__action__Action_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
om_aiv_msg__action__Action_Feedback__Sequence__are_equal(const om_aiv_msg__action__Action_Feedback__Sequence * lhs, const om_aiv_msg__action__Action_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!om_aiv_msg__action__Action_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  om_aiv_msg__action__Action_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(om_aiv_msg__action__Action_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    om_aiv_msg__action__Action_Feedback * data =
      (om_aiv_msg__action__Action_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!om_aiv_msg__action__Action_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          om_aiv_msg__action__Action_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!om_aiv_msg__action__Action_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
om_aiv_msg__action__Action_SendGoal_Request__are_equal(const om_aiv_msg__action__Action_SendGoal_Request * lhs, const om_aiv_msg__action__Action_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!om_aiv_msg__action__Action_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_SendGoal_Request * msg = (om_aiv_msg__action__Action_SendGoal_Request *)allocator.allocate(sizeof(om_aiv_msg__action__Action_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
om_aiv_msg__action__Action_SendGoal_Request__Sequence__init(om_aiv_msg__action__Action_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (om_aiv_msg__action__Action_SendGoal_Request *)allocator.zero_allocate(size, sizeof(om_aiv_msg__action__Action_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_SendGoal_Request__Sequence * array = (om_aiv_msg__action__Action_SendGoal_Request__Sequence *)allocator.allocate(sizeof(om_aiv_msg__action__Action_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
om_aiv_msg__action__Action_SendGoal_Request__Sequence__are_equal(const om_aiv_msg__action__Action_SendGoal_Request__Sequence * lhs, const om_aiv_msg__action__Action_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!om_aiv_msg__action__Action_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  om_aiv_msg__action__Action_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(om_aiv_msg__action__Action_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    om_aiv_msg__action__Action_SendGoal_Request * data =
      (om_aiv_msg__action__Action_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!om_aiv_msg__action__Action_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          om_aiv_msg__action__Action_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!om_aiv_msg__action__Action_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_SendGoal_Response * msg = (om_aiv_msg__action__Action_SendGoal_Response *)allocator.allocate(sizeof(om_aiv_msg__action__Action_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
om_aiv_msg__action__Action_SendGoal_Response__Sequence__init(om_aiv_msg__action__Action_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (om_aiv_msg__action__Action_SendGoal_Response *)allocator.zero_allocate(size, sizeof(om_aiv_msg__action__Action_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_SendGoal_Response__Sequence * array = (om_aiv_msg__action__Action_SendGoal_Response__Sequence *)allocator.allocate(sizeof(om_aiv_msg__action__Action_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
om_aiv_msg__action__Action_SendGoal_Response__Sequence__are_equal(const om_aiv_msg__action__Action_SendGoal_Response__Sequence * lhs, const om_aiv_msg__action__Action_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!om_aiv_msg__action__Action_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  om_aiv_msg__action__Action_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(om_aiv_msg__action__Action_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    om_aiv_msg__action__Action_SendGoal_Response * data =
      (om_aiv_msg__action__Action_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!om_aiv_msg__action__Action_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          om_aiv_msg__action__Action_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!om_aiv_msg__action__Action_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
om_aiv_msg__action__Action_SendGoal_Event__init(om_aiv_msg__action__Action_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    om_aiv_msg__action__Action_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!om_aiv_msg__action__Action_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    om_aiv_msg__action__Action_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!om_aiv_msg__action__Action_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    om_aiv_msg__action__Action_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
om_aiv_msg__action__Action_SendGoal_Event__fini(om_aiv_msg__action__Action_SendGoal_Event * msg)
{
  ...
  // request
  om_aiv_msg__action__Action_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  om_aiv_msg__action__Action_SendGoal_Response__Sequence__fini(&msg->response);
}
...
om_aiv_msg__action__Action_SendGoal_Event__are_equal(const om_aiv_msg__action__Action_SendGoal_Event * lhs, const om_aiv_msg__action__Action_SendGoal_Event * rhs)
{
  ...
  // request
  if (!om_aiv_msg__action__Action_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!om_aiv_msg__action__Action_SendGoal_Response__Sequence__are_equal(
  ...
  om_aiv_msg__action__Action_SendGoal_Event * output)
{
  ...
  // request
  if (!om_aiv_msg__action__Action_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!om_aiv_msg__action__Action_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_SendGoal_Event * msg = (om_aiv_msg__action__Action_SendGoal_Event *)allocator.allocate(sizeof(om_aiv_msg__action__Action_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(om_aiv_msg__action__Action_SendGoal_Event));
  bool success = om_aiv_msg__action__Action_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
om_aiv_msg__action__Action_SendGoal_Event__Sequence__init(om_aiv_msg__action__Action_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_SendGoal_Event * data = NULL;

  if (size) {
    data = (om_aiv_msg__action__Action_SendGoal_Event *)allocator.zero_allocate(size, sizeof(om_aiv_msg__action__Action_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = om_aiv_msg__action__Action_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        om_aiv_msg__action__Action_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
om_aiv_msg__action__Action_SendGoal_Event__Sequence__fini(om_aiv_msg__action__Action_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      om_aiv_msg__action__Action_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_SendGoal_Event__Sequence * array = (om_aiv_msg__action__Action_SendGoal_Event__Sequence *)allocator.allocate(sizeof(om_aiv_msg__action__Action_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = om_aiv_msg__action__Action_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
om_aiv_msg__action__Action_SendGoal_Event__Sequence__destroy(om_aiv_msg__action__Action_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    om_aiv_msg__action__Action_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
om_aiv_msg__action__Action_SendGoal_Event__Sequence__are_equal(const om_aiv_msg__action__Action_SendGoal_Event__Sequence * lhs, const om_aiv_msg__action__Action_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!om_aiv_msg__action__Action_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  om_aiv_msg__action__Action_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(om_aiv_msg__action__Action_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    om_aiv_msg__action__Action_SendGoal_Event * data =
      (om_aiv_msg__action__Action_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!om_aiv_msg__action__Action_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          om_aiv_msg__action__Action_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!om_aiv_msg__action__Action_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_GetResult_Request * msg = (om_aiv_msg__action__Action_GetResult_Request *)allocator.allocate(sizeof(om_aiv_msg__action__Action_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
om_aiv_msg__action__Action_GetResult_Request__Sequence__init(om_aiv_msg__action__Action_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (om_aiv_msg__action__Action_GetResult_Request *)allocator.zero_allocate(size, sizeof(om_aiv_msg__action__Action_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_GetResult_Request__Sequence * array = (om_aiv_msg__action__Action_GetResult_Request__Sequence *)allocator.allocate(sizeof(om_aiv_msg__action__Action_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
om_aiv_msg__action__Action_GetResult_Request__Sequence__are_equal(const om_aiv_msg__action__Action_GetResult_Request__Sequence * lhs, const om_aiv_msg__action__Action_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!om_aiv_msg__action__Action_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  om_aiv_msg__action__Action_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(om_aiv_msg__action__Action_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    om_aiv_msg__action__Action_GetResult_Request * data =
      (om_aiv_msg__action__Action_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!om_aiv_msg__action__Action_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          om_aiv_msg__action__Action_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!om_aiv_msg__action__Action_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
om_aiv_msg__action__Action_GetResult_Response__are_equal(const om_aiv_msg__action__Action_GetResult_Response * lhs, const om_aiv_msg__action__Action_GetResult_Response * rhs)
{
  ...
  // result
  if (!om_aiv_msg__action__Action_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_GetResult_Response * msg = (om_aiv_msg__action__Action_GetResult_Response *)allocator.allocate(sizeof(om_aiv_msg__action__Action_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
om_aiv_msg__action__Action_GetResult_Response__Sequence__init(om_aiv_msg__action__Action_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (om_aiv_msg__action__Action_GetResult_Response *)allocator.zero_allocate(size, sizeof(om_aiv_msg__action__Action_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_GetResult_Response__Sequence * array = (om_aiv_msg__action__Action_GetResult_Response__Sequence *)allocator.allocate(sizeof(om_aiv_msg__action__Action_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
om_aiv_msg__action__Action_GetResult_Response__Sequence__are_equal(const om_aiv_msg__action__Action_GetResult_Response__Sequence * lhs, const om_aiv_msg__action__Action_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!om_aiv_msg__action__Action_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  om_aiv_msg__action__Action_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(om_aiv_msg__action__Action_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    om_aiv_msg__action__Action_GetResult_Response * data =
      (om_aiv_msg__action__Action_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!om_aiv_msg__action__Action_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          om_aiv_msg__action__Action_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!om_aiv_msg__action__Action_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
om_aiv_msg__action__Action_GetResult_Event__init(om_aiv_msg__action__Action_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    om_aiv_msg__action__Action_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!om_aiv_msg__action__Action_GetResult_Request__Sequence__init(&msg->request, 0)) {
    om_aiv_msg__action__Action_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!om_aiv_msg__action__Action_GetResult_Response__Sequence__init(&msg->response, 0)) {
    om_aiv_msg__action__Action_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
om_aiv_msg__action__Action_GetResult_Event__fini(om_aiv_msg__action__Action_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  om_aiv_msg__action__Action_GetResult_Request__Sequence__fini(&msg->request);
  // response
  om_aiv_msg__action__Action_GetResult_Response__Sequence__fini(&msg->response);
}
...
om_aiv_msg__action__Action_GetResult_Event__are_equal(const om_aiv_msg__action__Action_GetResult_Event * lhs, const om_aiv_msg__action__Action_GetResult_Event * rhs)
{
  ...
  // request
  if (!om_aiv_msg__action__Action_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!om_aiv_msg__action__Action_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  om_aiv_msg__action__Action_GetResult_Event * output)
{
  ...
  // request
  if (!om_aiv_msg__action__Action_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!om_aiv_msg__action__Action_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_GetResult_Event * msg = (om_aiv_msg__action__Action_GetResult_Event *)allocator.allocate(sizeof(om_aiv_msg__action__Action_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(om_aiv_msg__action__Action_GetResult_Event));
  bool success = om_aiv_msg__action__Action_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
om_aiv_msg__action__Action_GetResult_Event__Sequence__init(om_aiv_msg__action__Action_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_GetResult_Event * data = NULL;

  if (size) {
    data = (om_aiv_msg__action__Action_GetResult_Event *)allocator.zero_allocate(size, sizeof(om_aiv_msg__action__Action_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = om_aiv_msg__action__Action_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        om_aiv_msg__action__Action_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
om_aiv_msg__action__Action_GetResult_Event__Sequence__fini(om_aiv_msg__action__Action_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      om_aiv_msg__action__Action_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_GetResult_Event__Sequence * array = (om_aiv_msg__action__Action_GetResult_Event__Sequence *)allocator.allocate(sizeof(om_aiv_msg__action__Action_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = om_aiv_msg__action__Action_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
om_aiv_msg__action__Action_GetResult_Event__Sequence__destroy(om_aiv_msg__action__Action_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    om_aiv_msg__action__Action_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
om_aiv_msg__action__Action_GetResult_Event__Sequence__are_equal(const om_aiv_msg__action__Action_GetResult_Event__Sequence * lhs, const om_aiv_msg__action__Action_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!om_aiv_msg__action__Action_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  om_aiv_msg__action__Action_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(om_aiv_msg__action__Action_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    om_aiv_msg__action__Action_GetResult_Event * data =
      (om_aiv_msg__action__Action_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!om_aiv_msg__action__Action_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          om_aiv_msg__action__Action_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!om_aiv_msg__action__Action_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
om_aiv_msg__action__Action_FeedbackMessage__are_equal(const om_aiv_msg__action__Action_FeedbackMessage * lhs, const om_aiv_msg__action__Action_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!om_aiv_msg__action__Action_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_FeedbackMessage * msg = (om_aiv_msg__action__Action_FeedbackMessage *)allocator.allocate(sizeof(om_aiv_msg__action__Action_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
...
om_aiv_msg__action__Action_FeedbackMessage__Sequence__init(om_aiv_msg__action__Action_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (om_aiv_msg__action__Action_FeedbackMessage *)allocator.zero_allocate(size, sizeof(om_aiv_msg__action__Action_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  om_aiv_msg__action__Action_FeedbackMessage__Sequence * array = (om_aiv_msg__action__Action_FeedbackMessage__Sequence *)allocator.allocate(sizeof(om_aiv_msg__action__Action_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
om_aiv_msg__action__Action_FeedbackMessage__Sequence__are_equal(const om_aiv_msg__action__Action_FeedbackMessage__Sequence * lhs, const om_aiv_msg__action__Action_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!om_aiv_msg__action__Action_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  om_aiv_msg__action__Action_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(om_aiv_msg__action__Action_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    om_aiv_msg__action__Action_FeedbackMessage * data =
      (om_aiv_msg__action__Action_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!om_aiv_msg__action__Action_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          om_aiv_msg__action__Action_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!om_aiv_msg__action__Action_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
