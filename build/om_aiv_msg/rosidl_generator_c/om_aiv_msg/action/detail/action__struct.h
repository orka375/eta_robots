...
enum
{
  om_aiv_msg__action__Action_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  om_aiv_msg__action__Action_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Action in the package om_aiv_msg.
typedef struct om_aiv_msg__action__Action_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  om_aiv_msg__action__Action_SendGoal_Request__Sequence request;
  om_aiv_msg__action__Action_SendGoal_Response__Sequence response;
} om_aiv_msg__action__Action_SendGoal_Event;

// Struct for a sequence of om_aiv_msg__action__Action_SendGoal_Event.
typedef struct om_aiv_msg__action__Action_SendGoal_Event__Sequence
{
...
enum
{
  om_aiv_msg__action__Action_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  om_aiv_msg__action__Action_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/Action in the package om_aiv_msg.
typedef struct om_aiv_msg__action__Action_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  om_aiv_msg__action__Action_GetResult_Request__Sequence request;
  om_aiv_msg__action__Action_GetResult_Response__Sequence response;
} om_aiv_msg__action__Action_GetResult_Event;

// Struct for a sequence of om_aiv_msg__action__Action_GetResult_Event.
typedef struct om_aiv_msg__action__Action_GetResult_Event__Sequence
{
