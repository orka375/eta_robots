...
enum
{
  om_aiv_msg__srv__ArclApi_Event__request__MAX_SIZE = 1
};
// response
enum
{
  om_aiv_msg__srv__ArclApi_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/ArclApi in the package om_aiv_msg.
typedef struct om_aiv_msg__srv__ArclApi_Event
{
  service_msgs__msg__ServiceEventInfo info;
  om_aiv_msg__srv__ArclApi_Request__Sequence request;
  om_aiv_msg__srv__ArclApi_Response__Sequence response;
} om_aiv_msg__srv__ArclApi_Event;

// Struct for a sequence of om_aiv_msg__srv__ArclApi_Event.
typedef struct om_aiv_msg__srv__ArclApi_Event__Sequence
{
