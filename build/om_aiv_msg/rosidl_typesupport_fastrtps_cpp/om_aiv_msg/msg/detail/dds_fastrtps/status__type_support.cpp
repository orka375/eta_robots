...
#include "om_aiv_msg/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: location
  om_aiv_msg::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  om_aiv_msg::msg::Status & ros_message)
{
  ...
  // Member: location
  om_aiv_msg::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: location
  current_alignment +=
    om_aiv_msg::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: location
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        om_aiv_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_Location(
  ...
  if (is_plain) {
    ...
    using DataType = om_aiv_msg::msg::Status;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: location
  om_aiv_msg::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
    ros_message.location,
    cdr);
  ...
  size_t current_alignment)
{
  ...
  // Member: location
  current_alignment +=
    om_aiv_msg::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
    ros_message.location, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Member: location
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        om_aiv_msg::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Location(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const om_aiv_msg::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<om_aiv_msg::msg::Status *>(
    untyped_ros_message);
...
{
  return &om_aiv_msg::msg::typesupport_fastrtps_cpp::_Status__handle;
}
