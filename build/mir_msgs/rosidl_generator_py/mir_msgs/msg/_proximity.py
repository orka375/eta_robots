    ...
    def ranges(self, value):
        if self._check_fields:
            ...
            assert \
                ...
                "The 'ranges' field must be a set or sequence and each value of type 'int' and each unsigned integer in [0, 65535]"
