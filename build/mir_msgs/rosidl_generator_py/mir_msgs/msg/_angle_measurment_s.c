...
bool mir_msgs__msg__angle_measurment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mir_msgs.msg._angle_measurment", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("AngleMeasurment", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  mir_msgs__msg__AngleMeasurment * ros_message = _ros_message;
  {  // angle
...
{
  /* NOTE(esteve): Call constructor of AngleMeasurment */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mir_msgs.msg._angle_measurment");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AngleMeasurment");
