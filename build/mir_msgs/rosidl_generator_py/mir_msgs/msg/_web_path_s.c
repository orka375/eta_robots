...
bool mir_msgs__msg__web_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mir_msgs.msg._web_path", (char *)PyUnicode_1BYTE_DATA(module_attr), 22) == 0);
    assert(strncmp("WebPath", (char *)PyUnicode_1BYTE_DATA(name_attr), 7) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  mir_msgs__msg__WebPath * ros_message = _ros_message;
  {  // seq
...
{
  /* NOTE(esteve): Call constructor of WebPath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mir_msgs.msg._web_path");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "WebPath");
