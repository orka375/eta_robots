...
bool mir_msgs__msg__gripper_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mir_msgs.msg._gripper_state", (char *)PyUnicode_1BYTE_DATA(module_attr), 27) == 0);
    assert(strncmp("GripperState", (char *)PyUnicode_1BYTE_DATA(name_attr), 12) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  mir_msgs__msg__GripperState * ros_message = _ros_message;
  {  // state
...
PyObject * mir_msgs__msg__gripper_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mir_msgs.msg._gripper_state");
