...
#include "mir_msgs/msg/detail/twist2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mir_msgs::msg::Twist2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs::msg::Twist2D & ros_message)
{
  // Member: linear
  cdr >> ros_message.linear;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs::msg::Twist2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mir_msgs::msg::Twist2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mir_msgs::msg::Twist2D *>(
    untyped_ros_message);
...
{
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_Twist2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mir_msgs, msg, Twist2D)() {
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_Twist2D__handle;
}
