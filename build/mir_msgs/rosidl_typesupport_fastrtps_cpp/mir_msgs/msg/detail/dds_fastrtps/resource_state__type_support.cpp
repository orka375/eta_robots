  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: resource_geometry
  {
    ...
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.resource_geometry[i],
        cdr);
    }
  }
  ...
  mir_msgs::msg::ResourceState & ros_message)
{
  ...
  // Member: resource_geometry
  {
    ...
    ros_message.resource_geometry.resize(size);
    for (size_t i = 0; i < size; i++) {
      geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.resource_geometry[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: resource_geometry
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        geometry_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.resource_geometry[index], current_alignment);
    }
  }
