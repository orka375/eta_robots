...
#include "mir_msgs/msg/detail/robot_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mir_msgs::msg::RobotMode & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  cdr << ros_message.robot_mode_string;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs::msg::RobotMode & ros_message)
{
  // Member: robot_mode
  cdr >> ros_message.robot_mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs::msg::RobotMode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mir_msgs::msg::RobotMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mir_msgs::msg::RobotMode *>(
    untyped_ros_message);
...
get_message_type_support_handle<mir_msgs::msg::RobotMode>()
{
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_RobotMode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mir_msgs, msg, RobotMode)() {
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_RobotMode__handle;
}
