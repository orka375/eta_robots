...
#include "mir_msgs/msg/detail/proximity__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mir_msgs::msg::Proximity & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs::msg::Proximity & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs::msg::Proximity;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mir_msgs
max_serialized_size_key_Proximity(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mir_msgs::msg::Proximity *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mir_msgs::msg::Proximity *>(
    untyped_ros_message);
...
{
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_Proximity__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mir_msgs, msg, Proximity)() {
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_Proximity__handle;
}
