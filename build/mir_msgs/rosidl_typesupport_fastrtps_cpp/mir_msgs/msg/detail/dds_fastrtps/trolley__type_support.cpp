...
#include "mir_msgs/msg/detail/trolley__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mir_msgs::msg::Trolley & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs::msg::Trolley & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs::msg::Trolley;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mir_msgs::msg::Trolley *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mir_msgs::msg::Trolley *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Trolley__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mir_msgs::msg::Trolley *>(
...
static size_t _Trolley__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Trolley(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Trolley__callbacks = {
  "mir_msgs::msg",
  "Trolley",
...
static rosidl_message_type_support_t _Trolley__handle = {
...
{
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_Trolley__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mir_msgs, msg, Trolley)() {
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_Trolley__handle;
}
