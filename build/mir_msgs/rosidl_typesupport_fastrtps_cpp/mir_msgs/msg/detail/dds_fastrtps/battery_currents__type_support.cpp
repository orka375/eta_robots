...
#include "mir_msgs/msg/detail/battery_currents__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs::msg::BatteryCurrents;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mir_msgs
max_serialized_size_key_BatteryCurrents(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mir_msgs::msg::BatteryCurrents *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mir_msgs::msg::BatteryCurrents *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BatteryCurrents__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mir_msgs::msg::BatteryCurrents *>(
...
static size_t _BatteryCurrents__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BatteryCurrents(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BatteryCurrents__callbacks = {
  "mir_msgs::msg",
  "BatteryCurrents",
...
static rosidl_message_type_support_t _BatteryCurrents__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BatteryCurrents__callbacks,
...
{
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_BatteryCurrents__handle;
}
