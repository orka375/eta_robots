...
#include "mir_msgs/msg/detail/brake_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mir_msgs::msg::BrakeState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs::msg::BrakeState & ros_message)
{
  // Member: state
  cdr >> ros_message.state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs::msg::BrakeState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mir_msgs::msg::BrakeState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mir_msgs::msg::BrakeState *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BrakeState__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mir_msgs::msg::BrakeState *>(
...
static size_t _BrakeState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BrakeState(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BrakeState__callbacks = {
  "mir_msgs::msg",
  "BrakeState",
...
static rosidl_message_type_support_t _BrakeState__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BrakeState__callbacks,
...
{
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_BrakeState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mir_msgs, msg, BrakeState)() {
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_BrakeState__handle;
}
