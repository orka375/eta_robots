...
#include "mir_msgs/msg/detail/stamped_encoders__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mir_msgs::msg::Encoders &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mir_msgs::msg::Encoders &);
size_t get_serialized_size(
  const mir_msgs::msg::Encoders &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const mir_msgs::msg::StampedEncoders & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs::msg::StampedEncoders & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: encoders
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mir_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Encoders(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs::msg::StampedEncoders;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: encoders
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mir_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Encoders(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mir_msgs::msg::StampedEncoders *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mir_msgs::msg::StampedEncoders *>(
    untyped_ros_message);
...
get_message_type_support_handle<mir_msgs::msg::StampedEncoders>()
{
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_StampedEncoders__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mir_msgs, msg, StampedEncoders)() {
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_StampedEncoders__handle;
}
