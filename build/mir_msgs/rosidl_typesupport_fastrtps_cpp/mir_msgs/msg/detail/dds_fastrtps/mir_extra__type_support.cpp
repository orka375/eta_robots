...
#include "mir_msgs/msg/detail/mir_extra__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mir_msgs::msg::MirExtra & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs::msg::MirExtra & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs::msg::MirExtra;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mir_msgs
max_serialized_size_key_MirExtra(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const mir_msgs::msg::MirExtra *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mir_msgs::msg::MirExtra *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MirExtra__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mir_msgs::msg::MirExtra *>(
...
static size_t _MirExtra__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MirExtra(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MirExtra__callbacks = {
  "mir_msgs::msg",
  "MirExtra",
...
static rosidl_message_type_support_t _MirExtra__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MirExtra__callbacks,
...
get_message_type_support_handle<mir_msgs::msg::MirExtra>()
{
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_MirExtra__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mir_msgs, msg, MirExtra)() {
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_MirExtra__handle;
}
