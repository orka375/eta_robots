...
#include "mir_msgs/msg/detail/event__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mir_msgs::msg::Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: area_guid
  cdr << ros_message.area_guid;

  // Member: area_name
  cdr << ros_message.area_name;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs::msg::Event & ros_message)
{
  // Member: event_type
  cdr >> ros_message.event_type;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs::msg::Event;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mir_msgs::msg::Event *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mir_msgs::msg::Event *>(
    untyped_ros_message);
...
{
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mir_msgs, msg, Event)() {
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_Event__handle;
}
