...
#include "mir_msgs/msg/detail/plan_segment__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs::msg::PlanSegment;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mir_msgs::msg::PlanSegment *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mir_msgs::msg::PlanSegment *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PlanSegment__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const mir_msgs::msg::PlanSegment *>(
...
static size_t _PlanSegment__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlanSegment(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PlanSegment__callbacks = {
  "mir_msgs::msg",
  "PlanSegment",
...
static rosidl_message_type_support_t _PlanSegment__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_PlanSegment__callbacks,
...
{
  return &mir_msgs::msg::typesupport_fastrtps_cpp::_PlanSegment__handle;
}
