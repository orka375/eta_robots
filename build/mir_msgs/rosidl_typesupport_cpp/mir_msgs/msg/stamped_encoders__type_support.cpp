...
static const _StampedEncoders_type_support_symbol_names_t _StampedEncoders_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mir_msgs, msg, StampedEncoders)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mir_msgs, msg, StampedEncoders)),
  }
};
...
{
  return &::mir_msgs::msg::rosidl_typesupport_cpp::StampedEncoders_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mir_msgs, msg, StampedEncoders)() {
  return get_message_type_support_handle<mir_msgs::msg::StampedEncoders>();
}
