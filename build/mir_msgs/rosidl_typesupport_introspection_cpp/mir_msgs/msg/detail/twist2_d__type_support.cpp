...
{
  new (message_memory) mir_msgs::msg::Twist2D(_init);
}

void Twist2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mir_msgs::msg::Twist2D *>(message_memory);
  typed_message->~Twist2D();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Twist2D_message_member_array[2] = {
  {
    "linear",  // name
    ...
    offsetof(mir_msgs::msg::Twist2D, linear),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mir_msgs::msg::Twist2D, angular),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<mir_msgs::msg::Twist2D>()
{
  return &::mir_msgs::msg::rosidl_typesupport_introspection_cpp::Twist2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mir_msgs, msg, Twist2D)() {
  return &::mir_msgs::msg::rosidl_typesupport_introspection_cpp::Twist2D_message_type_support_handle;
}
