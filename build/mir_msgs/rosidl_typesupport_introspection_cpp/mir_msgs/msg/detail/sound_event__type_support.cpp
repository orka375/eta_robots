...
{
  new (message_memory) mir_msgs::msg::SoundEvent(_init);
}

void SoundEvent_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mir_msgs::msg::SoundEvent *>(message_memory);
  typed_message->~SoundEvent();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember SoundEvent_message_member_array[4] = {
  {
    "time_stamp",  // name
    ...
    offsetof(mir_msgs::msg::SoundEvent, time_stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mir_msgs::msg::SoundEvent, sound_guid),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mir_msgs::msg::SoundEvent, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mir_msgs::msg::SoundEvent, event),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SoundEvent_message_members = {
  ...
  4,  // number of fields
  sizeof(mir_msgs::msg::SoundEvent),
...
{
  return &::mir_msgs::msg::rosidl_typesupport_introspection_cpp::SoundEvent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mir_msgs, msg, SoundEvent)() {
  return &::mir_msgs::msg::rosidl_typesupport_introspection_cpp::SoundEvent_message_type_support_handle;
}
