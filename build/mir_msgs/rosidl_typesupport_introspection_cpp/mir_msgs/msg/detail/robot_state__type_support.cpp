...
{
  new (message_memory) mir_msgs::msg::RobotState(_init);
}

void RobotState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mir_msgs::msg::RobotState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotState_message_member_array[2] = {
  {
    ...
    offsetof(mir_msgs::msg::RobotState, robot_state),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mir_msgs::msg::RobotState, robot_state_string),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotState_message_members = {
  ...
  2,  // number of fields
  sizeof(mir_msgs::msg::RobotState),
...
{
  return &::mir_msgs::msg::rosidl_typesupport_introspection_cpp::RobotState_message_type_support_handle;
}
