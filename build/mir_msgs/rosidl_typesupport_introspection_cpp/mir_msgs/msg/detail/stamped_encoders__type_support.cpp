...
{
  new (message_memory) mir_msgs::msg::StampedEncoders(_init);
}

void StampedEncoders_fini_function(void * message_memory)
{
  auto typed_message = static_cast<mir_msgs::msg::StampedEncoders *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StampedEncoders_message_member_array[2] = {
  {
    ...
    offsetof(mir_msgs::msg::StampedEncoders, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<mir_msgs::msg::Encoders>(),  // members of sub message
    false,  // is key
    false,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(mir_msgs::msg::StampedEncoders, encoders),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StampedEncoders_message_members = {
  ...
  2,  // number of fields
  sizeof(mir_msgs::msg::StampedEncoders),
...
{
  return &::mir_msgs::msg::rosidl_typesupport_introspection_cpp::StampedEncoders_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mir_msgs, msg, StampedEncoders)() {
  return &::mir_msgs::msg::rosidl_typesupport_introspection_cpp::StampedEncoders_message_type_support_handle;
}
