...
bool mir_msgs__msg__mission_ctrl_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mir_msgs.msg._mission_ctrl_command", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("MissionCtrlCommand", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  mir_msgs__msg__MissionCtrlCommand * ros_message = _ros_message;
  {  // description
...
{
  /* NOTE(esteve): Call constructor of MissionCtrlCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mir_msgs.msg._mission_ctrl_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MissionCtrlCommand");
