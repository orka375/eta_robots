...
class Metaclass_MissionCtrlState(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'STATE_WAIT_LIFT_END_FLOOR_CONTINUE': cls.__constants['STATE_WAIT_LIFT_END_FLOOR_CONTINUE'],
        }
    ...
    @property
    def STATE_WAIT_LIFT_END_FLOOR_CONTINUE(self):
        """Message constant 'STATE_WAIT_LIFT_END_FLOOR_CONTINUE'."""
        return Metaclass_MissionCtrlState.__constants['STATE_WAIT_LIFT_END_FLOOR_CONTINUE']
...
class MissionCtrlState(metaclass=Metaclass_MissionCtrlState):
    ...
    Constants:
      ...
      STATE_WAIT_LIFT_END_FLOOR_CONTINUE
    """
