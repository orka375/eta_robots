...
bool mir_msgs__msg__error__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mir_msgs.msg._error", (char *)PyUnicode_1BYTE_DATA(module_attr), 19) == 0);
    assert(strncmp("Error", (char *)PyUnicode_1BYTE_DATA(name_attr), 5) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  mir_msgs__msg__Error * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // nolog
    PyObject * field = PyObject_GetAttrString(_pymsg, "nolog");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->nolog = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * mir_msgs__msg__error__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("mir_msgs.msg._error");
  ...
  {  // nolog
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->nolog ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "nolog", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
