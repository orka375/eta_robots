...
bool mir_msgs__msg__external_robot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mir_msgs.msg._external_robot", (char *)PyUnicode_1BYTE_DATA(module_attr), 28) == 0);
    assert(strncmp("ExternalRobot", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
