...
static rosidl_typesupport_introspection_c__MessageMember mir_msgs__msg__Error__rosidl_typesupport_introspection_c__Error_message_member_array[5] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mir_msgs__msg__Error, nolog),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
