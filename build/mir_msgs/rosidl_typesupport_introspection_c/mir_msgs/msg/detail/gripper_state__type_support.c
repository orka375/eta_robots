...
static rosidl_typesupport_introspection_c__MessageMember mir_msgs__msg__GripperState__rosidl_typesupport_introspection_c__GripperState_message_member_array[1] = {
  {
    "state",  // name
