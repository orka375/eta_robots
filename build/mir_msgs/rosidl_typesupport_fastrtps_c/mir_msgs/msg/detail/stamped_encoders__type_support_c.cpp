...
#include "mir_msgs/msg/detail/stamped_encoders__rosidl_typesupport_fastrtps_c.h"
...
#include "mir_msgs/msg/detail/encoders__functions.h"  // encoders
...
using _StampedEncoders__ros_msg_type = mir_msgs__msg__StampedEncoders;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
bool cdr_serialize_mir_msgs__msg__StampedEncoders(
  const mir_msgs__msg__StampedEncoders * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: encoders
  {
    cdr_serialize_mir_msgs__msg__Encoders(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
bool cdr_deserialize_mir_msgs__msg__StampedEncoders(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs__msg__StampedEncoders * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: encoders
  {
    cdr_deserialize_mir_msgs__msg__Encoders(cdr, &ros_message->encoders);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t get_serialized_size_mir_msgs__msg__StampedEncoders(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: encoders
  current_alignment += get_serialized_size_mir_msgs__msg__Encoders(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t max_serialized_size_mir_msgs__msg__StampedEncoders(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: encoders
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mir_msgs__msg__Encoders(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs__msg__StampedEncoders;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
bool cdr_serialize_key_mir_msgs__msg__StampedEncoders(
  const mir_msgs__msg__StampedEncoders * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: encoders
  {
    cdr_serialize_key_mir_msgs__msg__Encoders(
      &ros_message->encoders, cdr);
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t get_serialized_size_key_mir_msgs__msg__StampedEncoders(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StampedEncoders__ros_msg_type * ros_message = static_cast<const _StampedEncoders__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: encoders
  current_alignment += get_serialized_size_key_mir_msgs__msg__Encoders(
    &(ros_message->encoders), current_alignment);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t max_serialized_size_key_mir_msgs__msg__StampedEncoders(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: encoders
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mir_msgs__msg__Encoders(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mir_msgs__msg__StampedEncoders * ros_message = static_cast<const mir_msgs__msg__StampedEncoders *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mir_msgs__msg__StampedEncoders(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mir_msgs__msg__StampedEncoders * ros_message = static_cast<mir_msgs__msg__StampedEncoders *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mir_msgs__msg__StampedEncoders(cdr, ros_message);
}

static uint32_t _StampedEncoders__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mir_msgs__msg__StampedEncoders(
...
static size_t _StampedEncoders__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mir_msgs__msg__StampedEncoders(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mir_msgs, msg, StampedEncoders)() {
