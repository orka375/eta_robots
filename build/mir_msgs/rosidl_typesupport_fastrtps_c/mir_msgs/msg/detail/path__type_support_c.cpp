...
#include "mir_msgs/msg/detail/path__rosidl_typesupport_fastrtps_c.h"
...
#include "mir_msgs/msg/detail/pose2_d__functions.h"  // poses
...
using _Path__ros_msg_type = mir_msgs__msg__Path;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
bool cdr_serialize_mir_msgs__msg__Path(
  const mir_msgs__msg__Path * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
bool cdr_deserialize_mir_msgs__msg__Path(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs__msg__Path * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: poses
  {
    ...
    if (ros_message->poses.data) {
      mir_msgs__msg__Pose2D__Sequence__fini(&ros_message->poses);
    }
    ...
    auto array_ptr = ros_message->poses.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mir_msgs__msg__Pose2D(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t get_serialized_size_mir_msgs__msg__Path(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t max_serialized_size_mir_msgs__msg__Path(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs__msg__Path;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
bool cdr_serialize_key_mir_msgs__msg__Path(
  const mir_msgs__msg__Path * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t get_serialized_size_key_mir_msgs__msg__Path(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Path__ros_msg_type * ros_message = static_cast<const _Path__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t max_serialized_size_key_mir_msgs__msg__Path(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mir_msgs__msg__Path * ros_message = static_cast<const mir_msgs__msg__Path *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mir_msgs__msg__Path(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mir_msgs__msg__Path * ros_message = static_cast<mir_msgs__msg__Path *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mir_msgs__msg__Path(cdr, ros_message);
}

static uint32_t _Path__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mir_msgs__msg__Path(
...
static size_t _Path__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mir_msgs__msg__Path(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mir_msgs, msg, Path)() {
