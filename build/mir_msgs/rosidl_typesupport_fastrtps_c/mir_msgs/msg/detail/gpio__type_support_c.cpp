...
#include "mir_msgs/msg/detail/gpio__rosidl_typesupport_fastrtps_c.h"
...
using _Gpio__ros_msg_type = mir_msgs__msg__Gpio;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
bool cdr_serialize_mir_msgs__msg__Gpio(
  const mir_msgs__msg__Gpio * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
bool cdr_deserialize_mir_msgs__msg__Gpio(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs__msg__Gpio * ros_message)
{
  // Field name: ioport
  {
    cdr >> ros_message->ioport;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t get_serialized_size_mir_msgs__msg__Gpio(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t max_serialized_size_mir_msgs__msg__Gpio(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs__msg__Gpio;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
bool cdr_serialize_key_mir_msgs__msg__Gpio(
  const mir_msgs__msg__Gpio * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: ioport
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t get_serialized_size_key_mir_msgs__msg__Gpio(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Gpio__ros_msg_type * ros_message = static_cast<const _Gpio__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t max_serialized_size_key_mir_msgs__msg__Gpio(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mir_msgs__msg__Gpio * ros_message = static_cast<const mir_msgs__msg__Gpio *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mir_msgs__msg__Gpio(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mir_msgs__msg__Gpio * ros_message = static_cast<mir_msgs__msg__Gpio *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mir_msgs__msg__Gpio(cdr, ros_message);
}

static uint32_t _Gpio__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mir_msgs__msg__Gpio(
...
static size_t _Gpio__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mir_msgs__msg__Gpio(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mir_msgs, msg, Gpio)() {
