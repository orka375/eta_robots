...
#include "mir_msgs/msg/detail/pose2_d__rosidl_typesupport_fastrtps_c.h"
...
using _Pose2D__ros_msg_type = mir_msgs__msg__Pose2D;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mir_msgs__msg__Pose2D;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mir_msgs__msg__Pose2D * ros_message = static_cast<const mir_msgs__msg__Pose2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mir_msgs__msg__Pose2D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mir_msgs__msg__Pose2D * ros_message = static_cast<mir_msgs__msg__Pose2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mir_msgs__msg__Pose2D(cdr, ros_message);
}

static uint32_t _Pose2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mir_msgs__msg__Pose2D(
...
static size_t _Pose2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mir_msgs__msg__Pose2D(
