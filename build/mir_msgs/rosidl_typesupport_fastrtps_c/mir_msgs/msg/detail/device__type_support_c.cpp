  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mir_msgs__msg__Device * ros_message = static_cast<const mir_msgs__msg__Device *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mir_msgs__msg__Device(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mir_msgs__msg__Device * ros_message = static_cast<mir_msgs__msg__Device *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mir_msgs__msg__Device(cdr, ros_message);
}
