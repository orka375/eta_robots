...
bool cdr_serialize_mir_msgs__msg__LocalMapStat(
  const mir_msgs__msg__LocalMapStat * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
bool cdr_deserialize_mir_msgs__msg__LocalMapStat(
  eprosima::fastcdr::Cdr & cdr,
  mir_msgs__msg__LocalMapStat * ros_message)
{
  // Field name: idx
  {
    cdr >> ros_message->idx;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
bool cdr_serialize_key_mir_msgs__msg__LocalMapStat(
  const mir_msgs__msg__LocalMapStat * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: idx
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t get_serialized_size_key_mir_msgs__msg__LocalMapStat(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LocalMapStat__ros_msg_type * ros_message = static_cast<const _LocalMapStat__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mir_msgs
size_t max_serialized_size_key_mir_msgs__msg__LocalMapStat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mir_msgs__msg__LocalMapStat * ros_message = static_cast<const mir_msgs__msg__LocalMapStat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mir_msgs__msg__LocalMapStat(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mir_msgs__msg__LocalMapStat * ros_message = static_cast<mir_msgs__msg__LocalMapStat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mir_msgs__msg__LocalMapStat(cdr, ros_message);
}
