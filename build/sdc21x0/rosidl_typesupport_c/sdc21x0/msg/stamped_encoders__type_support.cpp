...
static const _StampedEncoders_type_support_symbol_names_t _StampedEncoders_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sdc21x0, msg, StampedEncoders)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, sdc21x0, msg, StampedEncoders)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, sdc21x0, msg, StampedEncoders)() {
  return &::sdc21x0::msg::rosidl_typesupport_c::StampedEncoders_message_type_support_handle;
}
