...
#ifndef SDC21X0__MSG__DETAIL__ENCODERS__STRUCT_HPP_
#define SDC21X0__MSG__DETAIL__ENCODERS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__sdc21x0__msg__Encoders __attribute__((deprecated))
#else
# define DEPRECATED__sdc21x0__msg__Encoders __declspec(deprecated)
#endif
...
struct Encoders_
{
  ...
  using ConstRawPtr =
    const sdc21x0::msg::Encoders_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sdc21x0::msg::Encoders_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sdc21x0::msg::Encoders_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sdc21x0::msg::Encoders_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sdc21x0::msg::Encoders_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sdc21x0::msg::Encoders_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sdc21x0::msg::Encoders_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sdc21x0::msg::Encoders_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sdc21x0__msg__Encoders
    std::shared_ptr<sdc21x0::msg::Encoders_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sdc21x0__msg__Encoders
    std::shared_ptr<sdc21x0::msg::Encoders_<ContainerAllocator> const>
...
using Encoders =
  sdc21x0::msg::Encoders_<std::allocator<void>>;
...
#endif  // SDC21X0__MSG__DETAIL__ENCODERS__STRUCT_HPP_
